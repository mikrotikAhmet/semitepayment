...
/**
 * @package     Semite LLC
 * @version     $Id: account.php Jun 28, 2014 ahmet
 ...
 */
// HTTP
define('HTTP_SERVER', 'http://local.semitepayment.com/merchant/');
...
// HTTPS
define('HTTPS_SERVER', 'https://local.semitepayment.com/merchant/');
define('HTTPS_PUBLIC', 'https://local.semitepayment.com/');
define('HTTPS_IMAGE', 'https://local.semitepayment.com/image/');

// DIR
define('DIR_APPLICATION', '/var/www/html/semitepayment.com/merchant/');
...
define('DIR_TEMPLATE', '/var/www/html/semitepayment.com/merchant/view/template/');
define('DIR_LANGUAGE', '/var/www/html/semitepayment.com/merchant/language/');
...
define('DIR_PUBLIC', '/var/www/html/semitepayment.com/public/');
