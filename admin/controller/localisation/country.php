...
class ControllerLocalisationCountry extends Controller {
    ...
    protected function getForm() {
        ...
        $this->data['geo_coords'] = '0, 0';
                
        if (isset($this->request->get['country_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
            $country_info = $this->model_localisation_country->getCountry($this->request->get['country_id']);
            $geo_data_info = $this->model_localisation_country->getCoordsByCountryId($this->request->get['country_id']);
            $this->data['geo_coords'] = (isset($geo_data_info['lat']) ? $geo_data_info['lat'] : null).', '.(isset($geo_data_info['lng']) ? $geo_data_info['lng'] : null);
        }
...
//            $this->data['coords'] = $this->request->post['coords'];
//        } elseif (!empty($map_point_info)) {
//            $this->data['coords'] = $map_point_info['point'];
//            
//            preg_match_all('/\((.*?)\)/', $map_point_info['point'], $matches);
//            $coords= $matches[1];
//        
//            $this->data['points'] = $coords;
//            
//        } else {
//            $this->data['coords'] = '';
