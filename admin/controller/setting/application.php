...
class ControllerSettingApplication extends Controller {
    ...
    public function getForm() {
        ...
        } elseif (isset($application_info['config_catalog_limit'])) {
            $this->data['config_catalog_limit'] = $application_info['config_catalog_limit'];
        } else {
        ...
        if (isset($this->request->post['config_tax'])) {
            ...
            $this->data['config_tax'] = $application_info['config_tax'];
        } else {
        ...
        if (isset($this->request->post['config_tax_default'])) {
            ...
            $this->data['config_tax_default'] = $application_info['config_tax_default'];
        } else {
        ...
        if (isset($this->request->post['config_tax_customer'])) {
            ...
            $this->data['config_tax_customer'] = $application_info['config_tax_customer'];
        } else {
        ...
        if (isset($this->request->post['config_cart_weight'])) {
            ...
            $this->data['config_cart_weight'] = $application_info['config_cart_weight'];
        } else {
        ...
        } elseif (isset($application_info['config_guest_checkout'])) {
            $this->data['config_guest_checkout'] = $application_info['config_guest_checkout'];
        } else {
        ...
        if (isset($this->request->post['config_checkout_id'])) {
            ...
            $this->data['config_checkout_id'] = $application_info['config_checkout_id'];
        } else {
        ...
        if (isset($this->request->post['config_order_status_id'])) {
            ...
            $this->data['config_order_status_id'] = $application_info['config_order_status_id'];
        } else {
        ...
        if (isset($this->request->post['config_stock_display'])) {
            ...
            $this->data['config_stock_display'] = $application_info['config_stock_display'];
        } else {
        ...
        if (isset($this->request->post['config_stock_checkout'])) {
            ...
            $this->data['config_stock_checkout'] = $application_info['config_stock_checkout'];
        } else {
        ...
        if (isset($this->request->post['config_image_category_height'])) {
            ...
            $this->data['config_image_category_height'] = $application_info['config_image_category_height'];
        } else {
        ...
        if (isset($this->request->post['config_image_thumb_width'])) {
            ...
            $this->data['config_image_thumb_width'] = $application_info['config_image_thumb_width'];
        } else {
        ...
        if (isset($this->request->post['config_image_thumb_height'])) {
            ...
            $this->data['config_image_thumb_height'] = $application_info['config_image_thumb_height'];
        } else {
        ...
        if (isset($this->request->post['config_image_popup_width'])) {
            ...
            $this->data['config_image_popup_width'] = $application_info['config_image_popup_width'];
        } else {
        ...
        if (isset($this->request->post['config_image_popup_height'])) {
            ...
            $this->data['config_image_popup_height'] = $application_info['config_image_popup_height'];
        } else {
        ...
        if (isset($this->request->post['config_image_product_width'])) {
            ...
            $this->data['config_image_product_width'] = $application_info['config_image_product_width'];
        } else {
        ...
        if (isset($this->request->post['config_image_product_height'])) {
            ...
            $this->data['config_image_product_height'] = $application_info['config_image_product_height'];
        } else {
        ...
        if (isset($this->request->post['config_image_category_width'])) {
            ...
            $this->data['config_image_category_width'] = $application_info['config_image_category_width'];
        } else {
        ...
        if (isset($this->request->post['config_image_additional_width'])) {
            ...
            $this->data['config_image_additional_width'] = $application_info['config_image_additional_width'];
        } else {
        ...
        if (isset($this->request->post['config_image_additional_height'])) {
            ...
            $this->data['config_image_additional_height'] = $application_info['config_image_additional_height'];
        } else {
        ...
        if (isset($this->request->post['config_image_related_width'])) {
            ...
            $this->data['config_image_related_width'] = $application_info['config_image_related_width'];
        } else {
        ...
        if (isset($this->request->post['config_image_related_height'])) {
            ...
            $this->data['config_image_related_height'] = $application_info['config_image_related_height'];
        } else {
        ...
        if (isset($this->request->post['config_image_compare_width'])) {
            ...
            $this->data['config_image_compare_width'] = $application_info['config_image_compare_width'];
        } else {
        ...
        if (isset($this->request->post['config_image_compare_height'])) {
            ...
            $this->data['config_image_compare_height'] = $application_info['config_image_compare_height'];
        } else {
        ...
        if (isset($this->request->post['config_image_wishlist_width'])) {
            ...
            $this->data['config_image_wishlist_width'] = $application_info['config_image_wishlist_width'];
        } else {
        ...
        if (isset($this->request->post['config_image_wishlist_height'])) {
            ...
            $this->data['config_image_wishlist_height'] = $application_info['config_image_wishlist_height'];
        } else {
        ...
        if (isset($this->request->post['config_image_cart_width'])) {
            ...
            $this->data['config_image_cart_width'] = $application_info['config_image_cart_width'];
        } else {
        ...
        if (isset($this->request->post['config_image_cart_height'])) {
            ...
            $this->data['config_image_cart_height'] = $application_info['config_image_cart_height'];
        } else {
