                ...
                <table class="table table-bordered table-check">
                    <thead>
                        <tr>
                            ...
                            <th class="left"><?php if ($sort == 'bd.title') { ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                          <td style="text-align: center;"><?php if ($block['selected']) { ?>
                            ...
                            <?php } ?></td>
                          <td class="left"><?php echo $block['title']; ?></td>
                          <td class="right"><?php foreach ($block['action'] as $action) { ?>
