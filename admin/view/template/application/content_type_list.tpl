            ...
            <div class="table-responsive">
                <table class="table table-bordered table-check">
                    ...
                    <tbody>
                        ...
                        <tr>
                          <td style="text-align: center;"><?php if ($content_type['selected']) { ?>
                            <input type="checkbox" name="selected[]" value="<?php echo $content_type['content_type_id']; ?>" checked="checked" />
                            <?php } else { ?>
                            <input type="checkbox" name="selected[]" value="<?php echo $content_type['content_type_id']; ?>" />
                            <?php } ?></td>
                          <td class="left"><?php echo $content_type['name']; ?></td>
                          <td class="right"><?php foreach ($content_type['action'] as $action) { ?>
