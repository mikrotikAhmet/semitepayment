...
/**
 * @package     Semite LLC
 * @version     $Id: index.php Jun 28, 2014 ahmet
...
// Configuration
if (file_exists(APPLICATION_PATH_COR . 'system/config/api.php')) {
    require_once(APPLICATION_PATH_COR . 'system/config/api.php');
} else {
