...
--
-- Host: localhost    Database: semitepayment
-- ------------------------------------------------------
...
INSERT INTO `engine4_address` VALUES (18,39,'','','','','','','','','',243,3994,0);
...
INSERT INTO `engine4_application` VALUES (1,'Semite Payment API','http://local.semitepayment.com/api/','https://local.semitepayment.com/api/'),(2,'Semite Payment Account','http://lmerchant.semitepayment.com/','https://lmerchant.semitepayment.com/');
/*!40000 ALTER TABLE `engine4_application` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `engine4_approval_request`
--

DROP TABLE IF EXISTS `engine4_approval_request`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `engine4_approval_request` (
  ...
  PRIMARY KEY (`approval_request_id`,`account_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `engine4_approval_request`
--

LOCK TABLES `engine4_approval_request` WRITE;
/*!40000 ALTER TABLE `engine4_approval_request` DISABLE KEYS */;
/*!40000 ALTER TABLE `engine4_approval_request` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `engine4_block`
--

DROP TABLE IF EXISTS `engine4_block`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `engine4_block` (
  `block_id` int(11) NOT NULL AUTO_INCREMENT,
  `image` varchar(255) DEFAULT NULL,
  `class` varchar(32) NOT NULL,
  `additional_classes` varchar(255) DEFAULT NULL,
  `show_title` tinyint(1) NOT NULL DEFAULT '0',
  `show_sub_title` tinyint(1) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `engine4_block`
--

LOCK TABLES `engine4_block` WRITE;
/*!40000 ALTER TABLE `engine4_block` DISABLE KEYS */;
INSERT INTO `engine4_block` VALUES (26,'','section-block','',0,0,0,'2014-06-24 19:29:20','2014-06-24 19:29:20'),(27,'','section-block','',0,0,0,'2014-06-24 19:33:08','2014-06-24 19:33:08'),(28,'','section-block','',0,0,0,'2014-06-24 19:33:35','2014-06-24 19:33:35'),(30,'','section-block','dark, office',0,0,0,'2014-07-18 11:42:21','2014-08-16 12:38:52'),(31,'','section-block','',1,1,0,'2014-07-23 11:07:34','2014-08-02 12:58:09'),(32,'','section-block','dark, grid',1,1,0,'2014-07-23 11:13:57','2014-08-02 14:45:03'),(33,'','section-block','',1,1,0,'2014-07-23 11:15:04','2014-08-02 15:12:15'),(34,'','section-block','section-block-highlight',0,0,0,'2014-08-02 15:15:50','2014-08-02 15:18:02'),(35,'','section-block','section-block-highlight',0,0,0,'2014-08-02 15:24:03','2014-08-02 15:24:03'),(36,'','section-block','',0,0,0,'2014-08-02 15:30:50','2014-08-02 15:35:11'),(37,'','section-block','',0,0,0,'2014-08-06 09:29:01','2014-08-06 12:18:28'),(38,'','section-block','section-block-highlight',0,0,0,'2014-08-16 12:22:45','2014-08-16 12:35:41'),(39,'','section-block','',0,0,0,'2014-08-31 11:39:57','2014-08-31 11:49:06');
/*!40000 ALTER TABLE `engine4_block` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `engine4_block_description`
--

DROP TABLE IF EXISTS `engine4_block_description`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `engine4_block_description` (
  `block_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `title` varchar(45) NOT NULL,
  `sub_title` varchar(96) NOT NULL,
  PRIMARY KEY (`block_id`,`language_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `engine4_block_description`
--

LOCK TABLES `engine4_block_description` WRITE;
/*!40000 ALTER TABLE `engine4_block_description` DISABLE KEYS */;
INSERT INTO `engine4_block_description` VALUES (26,1,'Merchant Terms of Use',''),(27,1,'Privacy Policy',''),(28,1,'Money Laundering',''),(30,1,'Register',''),(31,1,'Built for business.','Get the fastest, most reliable bitcoin integration on the planet.'),(32,1,'This garden has no walls.','SemitePay is relentlessly dedicated to providing open, resilient technology and infrastructure.'),(33,1,'A partner you can rely on.','INDUSTRY-LEADING LEGAL &amp; REGULATORY COMPLIANCE'),(34,1,'Start accepting bitcoin today.',''),(35,1,'Pricing',''),(36,1,'Developer',''),(37,1,'Semite VPOS',''),(38,1,'Registration Success',''),(39,1,'Merchant Account Application Requirements','');
/*!40000 ALTER TABLE `engine4_block_description` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `engine4_block_unit`
--

DROP TABLE IF EXISTS `engine4_block_unit`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `engine4_block_unit` (
  `block_unit_id` int(11) NOT NULL AUTO_INCREMENT,
  `block_id` int(11) NOT NULL,
  `class` varchar(32) NOT NULL,
  `additional_class` varchar(32) NOT NULL,
  `type` varchar(15) NOT NULL,
  `subject` text NOT NULL,
  `sort_order` int(3) NOT NULL,
  PRIMARY KEY (`block_unit_id`)
) ENGINE=InnoDB AUTO_INCREMENT=54 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `engine4_block_unit`
--

LOCK TABLES `engine4_block_unit` WRITE;
/*!40000 ALTER TABLE `engine4_block_unit` DISABLE KEYS */;
INSERT INTO `engine4_block_unit` VALUES (1,26,'row','','','a:1:{i:0;a:3:{s:4:\"type\";s:7:\"content\";s:10:\"subject_id\";s:2:\"82\";s:6:\"column\";s:9:\"col-md-12\";}}',1),(2,27,'row','','','a:1:{i:0;a:3:{s:4:\"type\";s:7:\"content\";s:10:\"subject_id\";s:2:\"85\";s:6:\"column\";s:9:\"col-md-12\";}}',1),(3,28,'row','','','a:1:{i:0;a:3:{s:4:\"type\";s:7:\"content\";s:10:\"subject_id\";s:2:\"84\";s:6:\"column\";s:9:\"col-md-12\";}}',1),(21,31,'row','unit','','a:2:{i:0;a:3:{s:4:\"type\";s:7:\"content\";s:10:\"subject_id\";s:2:\"88\";s:6:\"column\";s:8:\"col-md-6\";}i:1;a:3:{s:4:\"type\";s:7:\"content\";s:10:\"subject_id\";s:2:\"89\";s:6:\"column\";s:8:\"col-md-6\";}}',1),(22,31,'row','unit','','a:2:{i:4;a:3:{s:4:\"type\";s:7:\"content\";s:10:\"subject_id\";s:2:\"90\";s:6:\"column\";s:8:\"col-md-6\";}i:5;a:3:{s:4:\"type\";s:7:\"content\";s:10:\"subject_id\";s:2:\"91\";s:6:\"column\";s:8:\"col-md-6\";}}',2),(24,32,'row','','','a:3:{i:0;a:3:{s:4:\"type\";s:7:\"content\";s:10:\"subject_id\";s:2:\"96\";s:6:\"column\";s:8:\"col-md-4\";}i:1;a:3:{s:4:\"type\";s:7:\"content\";s:10:\"subject_id\";s:2:\"97\";s:6:\"column\";s:8:\"col-md-4\";}i:2;a:3:{s:4:\"type\";s:7:\"content\";s:10:\"subject_id\";s:2:\"98\";s:6:\"column\";s:8:\"col-md-4\";}}',1),(25,33,'row','','','a:2:{i:0;a:3:{s:4:\"type\";s:7:\"content\";s:10:\"subject_id\";s:2:\"99\";s:6:\"column\";s:8:\"col-md-6\";}i:1;a:3:{s:4:\"type\";s:7:\"content\";s:10:\"subject_id\";s:3:\"100\";s:6:\"column\";s:8:\"col-md-6\";}}',1),(26,34,'row','','','a:1:{i:0;a:3:{s:4:\"type\";s:7:\"content\";s:10:\"subject_id\";s:3:\"101\";s:6:\"column\";s:36:\"col-md-6 col-md-offset-3 text-center\";}}',1),(27,35,'row','','','a:1:{i:0;a:3:{s:4:\"type\";s:7:\"content\";s:10:\"subject_id\";s:3:\"102\";s:6:\"column\";s:9:\"col-md-12\";}}',1),(29,36,'row','','','a:1:{i:0;a:3:{s:4:\"type\";s:7:\"content\";s:10:\"subject_id\";s:3:\"103\";s:6:\"column\";s:9:\"col-md-12\";}}',1),(46,37,'row','unit','','a:1:{i:0;a:3:{s:4:\"type\";s:6:\"module\";s:10:\"subject_id\";s:2:\"26\";s:6:\"column\";s:24:\"col-md-6 col-md-offset-3\";}}',1),(50,38,'row','','','a:1:{i:0;a:3:{s:4:\"type\";s:7:\"content\";s:10:\"subject_id\";s:3:\"104\";s:6:\"column\";s:9:\"col-md-12\";}}',1),(51,30,'row','','','a:1:{i:0;a:3:{s:4:\"type\";s:6:\"module\";s:10:\"subject_id\";s:2:\"23\";s:6:\"column\";s:24:\"col-md-8 col-md-offset-2\";}}',1),(53,39,'row','','','a:1:{i:0;a:3:{s:4:\"type\";s:7:\"content\";s:10:\"subject_id\";s:3:\"105\";s:6:\"column\";s:9:\"col-md-12\";}}',1);
/*!40000 ALTER TABLE `engine4_block_unit` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `engine4_content`
--

DROP TABLE IF EXISTS `engine4_content`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `engine4_content` (
  `content_id` int(11) NOT NULL AUTO_INCREMENT,
  `image` varchar(255) DEFAULT NULL,
  `glyp_icon` varchar(255) DEFAULT NULL,
  `replace_image` tinyint(1) NOT NULL DEFAULT '0',
  `author` int(11) NOT NULL,
  `type` int(11) NOT NULL,
  `comment` tinyint(1) NOT NULL DEFAULT '0',
  `revision` tinyint(1) NOT NULL DEFAULT '0',
  `link_id` tinyint(1) NOT NULL DEFAULT '0',
  `status` tinyint(1) NOT NULL DEFAULT '1',
  `date_added` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `date_modified` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`content_id`,`author`)
) ENGINE=MyISAM AUTO_INCREMENT=106 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `engine4_content`
--

LOCK TABLES `engine4_content` WRITE;
/*!40000 ALTER TABLE `engine4_content` DISABLE KEYS */;
INSERT INTO `engine4_content` VALUES (82,'',NULL,0,1,16,0,0,0,1,'2014-06-24 19:12:04','2014-06-24 19:12:04'),(83,'',NULL,0,1,17,0,0,0,1,'2014-06-24 19:12:59','2014-06-24 19:13:28'),(84,'',NULL,0,1,16,0,0,0,1,'2014-06-24 19:14:16','2014-06-24 19:14:16'),(85,'',NULL,0,1,17,0,0,0,1,'2014-06-24 19:14:44','2014-06-24 19:14:44'),(86,'',NULL,0,1,17,0,0,0,1,'2014-06-24 19:15:17','2014-06-24 19:15:17'),(87,'',NULL,0,1,16,0,0,0,1,'2014-07-09 10:10:54','2014-07-09 10:10:54'),(88,'data/Images/Payment-Methods-Bank-cards-icon-145x145.png','',0,1,15,0,1,0,1,'2014-07-23 11:01:48','2014-08-02 15:07:33'),(89,'data/Images/Payment-Methods-Banknotes-icon-145x145.png',NULL,0,1,15,0,1,0,1,'2014-07-23 11:03:23','2014-08-02 13:03:19'),(90,'data/Images/Payment-Methods-Cash-receiving-icon-145x145.png',NULL,0,1,15,0,1,0,1,'2014-07-23 11:04:42','2014-08-02 13:03:33'),(91,'data/Images/Maps-and-Geolocation-World-map-icon-145x145.png',NULL,0,1,15,0,1,0,1,'2014-07-23 11:05:21','2014-08-02 13:03:44'),(96,'','fa fa-lightbulb-o fa-5x',1,1,15,0,0,0,1,'2014-08-02 14:40:53','2014-08-02 15:07:48'),(97,'','fa fa-compass fa-5x',1,1,15,0,0,0,1,'2014-08-02 14:44:07','2014-08-02 15:09:53'),(98,'','fa fa-code fa-5x',1,1,15,0,0,0,1,'2014-08-02 14:44:41','2014-08-02 15:10:08'),(99,'','fa fa-lock fa-5x',1,1,15,0,0,0,1,'2014-08-02 15:10:50','2014-08-02 15:10:50'),(100,'','fa fa-shield fa-5x',1,1,15,0,0,0,1,'2014-08-02 15:11:21','2014-08-02 15:11:21'),(101,'','',0,1,15,0,0,0,1,'2014-08-02 15:14:23','2014-08-02 15:19:06'),(102,'','',0,1,16,0,0,0,1,'2014-08-02 15:23:06','2014-08-02 15:23:06'),(103,'','',0,1,16,0,0,0,1,'2014-08-02 15:34:55','2014-08-02 15:34:55'),(104,'','',0,1,16,0,0,0,1,'2014-08-16 12:18:13','2014-08-16 12:46:16'),(105,'','',0,1,16,0,0,0,1,'2014-08-31 11:37:24','2014-08-31 11:54:41');
/*!40000 ALTER TABLE `engine4_content` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `engine4_content_description`
--

DROP TABLE IF EXISTS `engine4_content_description`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `engine4_content_description` (
...
--
-- Dumping data for table `engine4_content_description`
--

LOCK TABLES `engine4_content_description` WRITE;
/*!40000 ALTER TABLE `engine4_content_description` DISABLE KEYS */;
INSERT INTO `engine4_content_description` VALUES (82,1,'Merchant Terms Of Use','&lt;h2 id=&quot;terms-of-use&quot;&gt;Merchant Terms of Use&lt;/h2&gt;\r\n\r\n&lt;p&gt;These Merchant Terms of Use (the Terms) govern your use of the products, services or any other features, technologies or functionalities (the Services) provided by SemitePay, Inc. (SemitePay, we, our, or us) through SemitePay’s website, API or through any other means. &lt;b&gt;You&lt;/b&gt; and &lt;b&gt;your&lt;/b&gt; mean the merchant to which we will be providing the Services and the person signing below or otherwise agreeing to the Terms on behalf of the merchant. Please read the Terms carefully; by using the Services, you agree to the Terms and confirm that you accept them.&lt;/p&gt;\r\n\r\n&lt;h3 id=&quot;the-services&quot;&gt;The Services&lt;/h3&gt;\r\n\r\n&lt;p&gt;We are a SemitePay payment processor—we enable you to accept payment for goods or services, and process payments that you receive from your customers. We are not a currency exchanger or a place to purchase any currency. By using the Services, you authorize us to receive, hold and disburse funds on your behalf and to take any and all actions that we think are necessary or desirable to provide the Services and to comply with applicable law.&lt;/p&gt;\r\n\r\n&lt;h3 id=&quot;registration&quot;&gt;Registration&lt;/h3&gt;\r\n\r\n&lt;h4&gt;Generally&lt;/h4&gt;\r\n\r\n&lt;p&gt;In order to use the Services, you must open a SemitePay account. When you open an account, we will ask you for contact information such as, for instance, your name, mailing address, phone number, email address, and website. The information that you provide at the time of account opening must be accurate and complete, and you must inform us in a timely fashion of any changes to such information. We may require additional information about you (including any person signing below or otherwise agreeing to the Terms on behalf of the merchant) such as, for instance, your date of birth, tax identification number or government-issued identification, and we may also obtain information about you from third parties, such as credit bureaus and identity verification services. We have the right to reject your account registration, or to later close your SemitePay account, if you do not provide us with accurate, complete and satisfactory information.&lt;/p&gt;\r\n\r\n&lt;h5&gt;Merchant Tiers&lt;/h5&gt;\r\n\r\n&lt;p&gt;SemitePay imposes daily transaction processing limits on merchants. When you register for a SemitePay account, you will be required to select the limit (the Tier) that will apply to your SemitePay account, and to provide us with the documentation necessary to qualify for that Tier. A description of the Tiers, as well as a list of the documentation required to qualify for each, is available on our website. If your business is a High Risk category, as determined by SemitePay, you will be required to qualify for the “Trusted” Tier in order to use the Services. We will not begin to process payments on your behalf until we have reviewed the documentation that you provide, in accordance with applicable law. If you wish to change to a Tier with a higher limit, you must provide us with the additional required documentation. We will not approve your request to change Tiers and permit you a greater processing volume unless and until we have reviewed your documentation to our satisfaction. Please also refer to Section 3.1, “Daily Transaction Volume; Tiers.”&lt;/p&gt;\r\n\r\n&lt;h4&gt;Guarding your Password&lt;/h4&gt;\r\n\r\n&lt;p&gt;You will choose a password when registering. You are responsible for maintaining the confidentiality of your password and account. You are fully responsible for all activities that occur using your password or account. Please notify us immediately of any unauthorized use of your password or account or any other breach of security. We will not be liable for any loss that you may incur as a result of someone else using your password or account, either with or without your knowledge. You may not use anyone else’s password at any time.&lt;/p&gt;\r\n\r\n&lt;h4&gt;Prohibited Accounts&lt;/h4&gt;\r\n\r\n&lt;p&gt;Use of the Services is subject to the laws and regulations of the Turkish Republic of Northern Cyprus (TRNC) regarding the prevention of terrorist financing and anti-money laundering. You agree and acknowledge that your use of the Services would and will comport with such laws and regulations, including, without limitation, the sanctions programs administered by the Office of Foreign Assets Control of the Turkish Republic of Northern Cyprus (TRNC) Department of the Treasury.&lt;/p&gt;\r\n\r\n&lt;h3 id=&quot;your-sales&quot;&gt;Your Sales&lt;/h3&gt;\r\n\r\n&lt;h4&gt;Daily Transaction Volume; Tiers&lt;/h4&gt;\r\n\r\n&lt;p&gt;You agree to adhere to the transaction processing limits applicable to your Tier. You agree that, if you exceed that limit, SemitePay has the right to hold the over-the-limit funds until you have provided us with the additional documentation required to qualify for the next Tier, and until we have had the opportunity to review such documents. We will take additional measures if you exceed your limit. If you are a “Trusted” merchant, you may create an unlimited value of invoices (see Section 8.1), although you will only receive payments from us up to the specified limit. If you are not a “Trusted” merchant, you may not create a value of invoices that exceeds your specified limit.&lt;/p&gt;\r\n\r\n&lt;h4&gt;Invoices and Records&lt;/h4&gt;\r\n\r\n&lt;p&gt;You must keep all records needed for fulfilling the merchandise to the purchaser and providing any post-sale support to the purchaser. If the sale of the item requires any government registration of the sale, you are responsible for such registration.&lt;/p&gt;\r\n\r\n&lt;h4&gt;Customer Verification&lt;/h4&gt;\r\n\r\n&lt;p&gt;You are solely responsible for obtaining any information required of those who purchase your goods or services. For instance, if applicable law prohibits a sale to persons under the age of 18 years, you must ensure that a purchaser is at least 18 years of age. Similarly, if applicable law requires that a purchaser’s identity be verified, you must verify the purchaser’s identity. We will not be responsible for your failure to adequately verify your purchasers’ identities or qualifications.&lt;/p&gt;\r\n\r\n&lt;p&gt;&amp;nbsp;&lt;/p&gt;\r\n\r\n&lt;h4 id=&quot;prohibited&quot;&gt;Representation and Warranties&lt;/h4&gt;\r\n\r\n&lt;p&gt;Your use of the Services is subject to several important restrictions. Specifically, you represent and warrant to us that:&lt;/p&gt;\r\n\r\n&lt;p&gt;(a) Your use of the Services will not contravene any applicable international, federal, state or local law or regulation, including applicable tax laws and regulations, and that your use of the Services will not violate the laws of the Turkish Republic of Northern Cyprus (TRNC).&lt;/p&gt;\r\n\r\n&lt;p&gt;(b) Your use of the Services will not relate to sales of (i) narcotics, research chemicals or any controlled substances, (ii) cash or cash equivalents, including derivatives, (iii) items that infringe or violate any copyright or trademark, (iv) ammunition, firearms, explosives, weapons or knives regulated under applicable law, or (v) any services which compete with SemitePay.&lt;/p&gt;\r\n\r\n&lt;p&gt;(c) Your use of the Services will not relate to transactions that (i) show the personal information of third parties in violation of applicable law, (ii) support pyramid or Ponzi schemes, matrix programs or other “get rich quick” schemes, (iii) are associated with purchases of annuities or lottery contracts, lay-away systems, off-shore banking or transactions to finance or refinance debts funded by a credit card, (iv) are associated with Money Service Business activities, as defined by the Financial Crimes Enforcement Network of the Turkish Republic of Northern Cyprus (TRNC) Department of the Treasury, or (v) provide credit repair or debt settlement services.&lt;/p&gt;\r\n\r\n&lt;p&gt;(d) Your use of the Services will not involve gambling or any other activity with an entry fee and a prize, including, but not limited to casino games, sports betting, horse or greyhound racing, lottery tickets, other ventures that facilitate gambling, and sweepstakes, unless you have obtained our prior approval and you and your customers are located exclusively in jurisdictions where such activities are permitted by law.&lt;/p&gt;\r\n\r\n&lt;p&gt;(f) You have the right, power and ability to enter into and perform under these Terms.&lt;/p&gt;\r\n\r\n&lt;h4&gt;Our Right to Reject&lt;/h4&gt;\r\n\r\n&lt;p&gt;We reserve the right to decline to process a sale if we believe that it violates these Terms or would expose you, other merchants, purchasers, or other parties to harm. If we reasonably suspect that your SemitePay account has been used for an illegal purpose, you authorize us to share information about you, your SemitePay account, and your account activity with law enforcement.&lt;/p&gt;\r\n\r\n&lt;h4&gt;Our Right to Inspect&lt;/h4&gt;\r\n\r\n&lt;p&gt;We may ask for permission to inspect your business location, in connection with your use of the Services or specific transactions. If you refuse our request, we may suspend or terminate your SemitePay account.&lt;/p&gt;\r\n\r\n&lt;h3 id=&quot;third-parties&quot;&gt;Third Parties&lt;/h3&gt;\r\n\r\n&lt;h4&gt;Your Use of Third-Party Services&lt;/h4&gt;\r\n\r\n&lt;p&gt;In using the SemitePay website or the Services, you may be offered services, products and promotions provided by third parties. If you decide to use these third-party services, you do so at your own risk and are solely responsible for reviewing, understanding and complying with the associated terms and conditions. We expressly disclaim any liability for the third-party services and are not responsible for the performance of the third-party services or servicers.&lt;/p&gt;\r\n\r\n&lt;h4&gt;Security&lt;/h4&gt;\r\n\r\n&lt;p&gt;We have implemented security measures designed to secure your information from accidental loss and from unauthorized access, use, alteration or disclosure. However, we cannot guarantee that unauthorized persons will never gain access to your information, and you acknowledge that you provide your information at your own risk, except as otherwise provided by applicable law.&lt;/p&gt;\r\n\r\n&lt;h3 id=&quot;collect-use-share&quot;&gt;How we Collect, Use and Share Information&lt;/h3&gt;\r\n\r\n&lt;p&gt;In order to provide the Services, we may share information about you and your SemitePay account with third parties, including but not limited to your bank and purchasers.&lt;/p&gt;\r\n\r\n&lt;h3 id=&quot;our-ownership&quot;&gt;Our Ownership of the Services and the SemitePay Website&lt;/h3&gt;\r\n\r\n&lt;p&gt;You agree and acknowledge that we own all right, title and interest to and in the Services, the associated software, technology tools and content, the SemitePay website, the content displayed on the website, and other materials produced by and related to SemitePay (collectively, the SemitePay IP). You are only permitted to use the Services and the SemitePay IP to accept and receive payments, according to these Terms. When you accept the Terms, we grant you a personal, limited, revocable and non-transferable license to use the SemitePay IP, without the right to sublicense. You shall not rent, lease, sublicense, distribute, transfer, copy, reproduce, download, display, modify or timeshare the SemitePay IP or any portion thereof, or use the SemitePay IP as a component of or a base for products or services prepared for commercial sale, sublicense, lease, access or distribution. You shall not prepare any derivative work based on the Company IP, nor shall you translate, reverse engineer, decompile or disassemble the Company IP.&lt;/p&gt;\r\n\r\n&lt;h3 id=&quot;advertising&quot;&gt;Advertising&lt;/h3&gt;\r\n\r\n&lt;p&gt;By mutual consent, we may publish your corporate name, artwork, text and logo &lt;b&gt;(Merchant Content)&lt;/b&gt; on the SemitePay website and promotional materials to acknowledge you as our customer. You represent and warrant to us that you have the right to provide the Merchant Content to us, and that the use, copying, modification and publication of the Merchant Content by us: (a) will not infringe, violate or misappropriate any third party copyright, patent, trade secret or other proprietary rights, (b) will not infringe any rights of publicity or privacy, and (c) will not be defamatory or obscene or otherwise violate any law.&lt;/p&gt;\r\n\r\n&lt;h3 id=&quot;fees-and-settlement&quot;&gt;Fees &amp;amp; Settlement&lt;/h3&gt;\r\n\r\n&lt;h4&gt;Invoice Generation and Exchange Rate Guarantee&lt;/h4&gt;\r\n\r\n&lt;p&gt;To create an invoice, you may post a request to SemitePay to collect a specific amount in your local currency, such as dollars or euros, or in Bitcoin. SemitePay will pull the exchange rate and provide the Bitcoin payment instructions to the purchaser. We guarantee the exchange rate to you as long as the purchaser pays within the proper time window after the invoice is created. Invoice timeout information is clearly displayed on each SemitePay invoice. While we guarantee the exchange rate as long as the purchaser pays within such time window, you agree that you assume the volatility risk of your local currency or Bitcoin, as applicable. For instance, if you ask us to collect USD $150, and the purchaser sends the payment within the time window, we guarantee you will receive exactly USD $150, minus our fee, but do not guarantee the value of the U.S. dollar.&lt;/p&gt;\r\n\r\n&lt;p&gt;&amp;nbsp;&lt;/p&gt;\r\n\r\n&lt;h4&gt;Fees&lt;/h4&gt;\r\n\r\n&lt;p&gt;We charge a processing fee on all transactions. The proceeds payable to you will equal the amount of the invoice (assuming that we have received the full amount of the invoice from the purchaser), unless you agree to accept less than the amount of the invoice, minus the processing fee. We reserve the right to change our fees and will give you 30 calendar days’ prior notice of any fee increase. Your continued use of the Services after we notify you of any increase in our fees constitutes your acceptance of such change. Current pricing information is provided on the SemitePay website at https://semitepayment.com/pricing.&lt;/p&gt;\r\n\r\n&lt;h4&gt;Methods of Settlement&lt;/h4&gt;\r\n\r\n&lt;p&gt;We will clear the payments over the Bitcoin peer-to-peer payment network and post the balance to your accounting ledger, according to your preference settings. The debits and credits to your accounting ledger are funds temporarily held by SemitePay until settlement to your bank account can take place. You can receive a settlement in your local currency, in Bitcoins, or in a mixture of both. You assume volatility risks of the currency in which you choose to be settled. If you choose to keep bitcoins, then you assume the volatility risk of the bitcoin value.&lt;/p&gt;\r\n\r\n&lt;h4&gt;Settlements in Local Currencies&lt;/h4&gt;\r\n\r\n&lt;p&gt;Direct deposit to a bank account in a local currency is available to merchants located in certain countries. Please refer to Please refer to &lt;a href=&quot;https://SemitePay.com/bitcoin-direct-deposit&quot;&gt;https://semitepayment.com/direct-deposit&lt;/a&gt; for a list of those countries. If you wish to receive direct deposit, you must provide us with valid bank account information and keep such information current. We will send a direct deposit to your bank account to clear out your accumulated balance. Minimum settlement amounts apply; please refer to &lt;a href=&quot;https://SemitePay.com/bitcoin-direct-deposit&quot;&gt;https://semitepayment.com/direct-deposit&lt;/a&gt; for information related to minimum settlement amounts and deposit frequency.&lt;/p&gt;\r\n\r\n&lt;h4&gt;Your Bank Account&lt;/h4&gt;\r\n\r\n&lt;p&gt;You must provide us with written notice at least 1 business day prior to closing your bank account. If you wish to continue to receive direct deposits, you must provide us with information for a substitute bank account. You are solely liable for all fees and costs associated with your bank account and for all overdrafts. You authorize us to initiate electronic credits to your bank account at any time, as necessary to process your transactions. We will not be liable for any delays in receipt of funds or errors in bank account entries caused by third parties.&lt;/p&gt;\r\n\r\n&lt;h4&gt;Certain Deferrals&lt;/h4&gt;\r\n\r\n&lt;p&gt;If we need to conduct an investigation or resolve any pending dispute related to your SemitePay account, we may delay settlement or restrict access to your funds while we do so. Additionally, we may delay settlement or restrict access to your funds if required to do so by law, court order or at the request of law enforcement.&lt;/p&gt;\r\n\r\n&lt;h4&gt;Account Statements&lt;/h4&gt;\r\n\r\n&lt;p&gt;On demand, we will provide you with a statement detailing your account transaction and settlement history. Should you identify an error in the statement, you must notify us of such error within 30 calendar days.&lt;/p&gt;\r\n\r\n&lt;h3 id=&quot;refunds-and-adjustments&quot;&gt;Refunds and Adjustments&lt;/h3&gt;\r\n\r\n&lt;h4&gt;Refund Procedures&lt;/h4&gt;\r\n\r\n&lt;p&gt;In the event that you wish to issue a refund to a purchaser, SemitePay can handle this. You can decide to issue a partial refund or the full amount of the initial purchase. You can also decide whether to issue the original amount of the invoice in your local currency or in the number of Bitcoins paid. If you do not have enough funds in your SemitePay account to cover the refund, SemitePay may require you to deposit Bitcoins into your SemitePay account to cover the refund to the purchaser. Any required currency conversion during the refund process will be calculated at a spot rate determined by SemitePay, following the guidelines found here: &lt;a href=&quot;https://semitepayment.com/exchange-rates&quot;&gt;https://semitepayment.com/exchange-rates&lt;/a&gt;.&lt;/p&gt;\r\n\r\n&lt;h4&gt;Disclosure of Your Refund Policy&lt;/h4&gt;\r\n\r\n&lt;p&gt;Merchants are required to have a clear refund policy for their customers. We recommend you refund the amount of the initial purchase in the currency in which the item was priced.&lt;/p&gt;\r\n\r\n&lt;h4&gt;Purchaser Complaints&lt;/h4&gt;\r\n\r\n&lt;p&gt;Purchasers filing complaints about a purchase will be forwarded to you for resolution. SemitePay reserves the right to terminate accounts which receive excessive complaints.&lt;/p&gt;\r\n\r\n&lt;h3 id=&quot;account-termination&quot;&gt;Account Termination&lt;/h3&gt;\r\n\r\n&lt;h4&gt;Your Right to Close Your Account&lt;/h4&gt;\r\n\r\n&lt;p&gt;You may close your SemitePay account at any time. You will still be obligated to us for any fees incurred before the closure and we will remit to you funds not yet paid to you and associated with pre-closure sales. If your account balance is below our documented minimum transfer amount, you may be responsible for any transactions fees that may be incurred in the funds transfer.&lt;/p&gt;\r\n\r\n&lt;h4&gt;Our Right to Close or Suspend Your Account&lt;/h4&gt;\r\n\r\n&lt;p&gt;We may terminate these Terms and close your account, at our discretion, upon notice to you via email or phone communication. We may also suspend your access to the Services if we suspect that you have failed to comply with these Terms, pose an unacceptable fraud risk to us, or if you provide any false, incomplete, inaccurate or misleading information. We will not be liable to you for any losses that you incur in connection with our closure or suspension of your account.&lt;/p&gt;\r\n\r\n&lt;h4&gt;Effect of Account Closure&lt;/h4&gt;\r\n\r\n&lt;p&gt;If your SemitePay account is closed, you agree: (a) to continue to be bound by these Terms, (b) to immediately stop using the Services, (c) that the license provided under these Terms shall end, (d) that we reserve the right (but have no obligation) to delete all of your information and account data stored on our servers, and (e) that we shall not be liable to you or any third party for termination of access to the Services or for deletion of your information or account data.&lt;/p&gt;\r\n\r\n&lt;h3 id=&quot;indemnification&quot;&gt;Indemnification&lt;/h3&gt;\r\n\r\n&lt;p&gt;You agree to indemnify SemitePay, its affiliated and related entities, and any of its officers, directors, employees and agents from and against any claims, costs, losses, liabilities, damages, expenses and judgments of any and every kind (including, without limitation, costs, expenses, and reasonable attorneys’ fees) arising out of, relating to, or incurred in connection with any claim, complaint, action, audit, investigation, inquiry, or other proceeding instituted by a person or entity that arises or relates to: (a) any actual or alleged breach of your representations, warranties, or obligations set forth in these Terms; (b) your wrongful or improper use of the Services; (c) the products or services sold by you through the Services, including but not limited to any claims for false advertising, product defects, personal injury, death or property damage; or (d) any other party’s access or use of the Services with your account information.&lt;/p&gt;\r\n\r\n&lt;h3 id=&quot;no-warrenties&quot;&gt;No Warranties&lt;/h3&gt;\r\n\r\n&lt;p&gt;WE PROVIDE THE SERVICES ON AN “AS IS” AND “AS AVAILABLE” BASIS, AND YOUR USE OF THE SERVICES IS AT YOUR OWN RISK. TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, WE PROVIDE THE SERVICES WITHOUT WARRANTIES OF ANY KIND, WHETHER EXPRESS OR IMPLIED (INCLUDING, WITHOUT LIMITATION, WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, OR NON-INFRINGEMENT). WITHOUT LIMITING THE FOREGOING, WE DO NOT WARRANT THAT THE SERVICES (AND OUR WEBSITE): WILL OPERATE ERROR-FREE OR THAT DEFECTS OR ERRORS WILL BE CORRECTED; WILL MEET YOUR REQUIREMENTS OR WILL BE AVAILABLE, UNINTERRUPTED OR SECURE AT ANY PARTICULAR TIME OR LOCATION; ARE FREE FROM VIRUSES OR OTHER HARMFUL CONTENT. WE DO NOT ENDORESE, WARRANT, GURANTEE OR ASSUME RESPONSIBILITY FOR ANY PRODUCT OR SERVCE OFFERED OR ADVERTISED BY A THIRD PARTY THROUGH THE SERVICES OR THROUGH OUR WEBSITE, AND WE WILL NOT BE A PARTY TO NOR MONITOR ANY INTERACTIONS BETWEEN YOU AND THIRD-PARTY PROVIDERS OF PRODUCTS OR SERVICES.&lt;/p&gt;\r\n\r\n&lt;h3 id=&quot;limitation-of-liability&quot;&gt;Limitation of Liability&lt;/h3&gt;\r\n\r\n&lt;p&gt;IN NO EVENT WILL WE BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY DIRECT, INDIRECT, SPECIAL, INCIDENTAL, CONSEQUENTIAL, EXEMPLARY OR PUNITIVE DAMAGES OR ANY LOSS, THEFT, DISAPPEARANCE, OR DAMAGES FOR LOST PROFITS, LOST REVENUES, LOST DATA OR OTHER INTANGIBLE LOSSES THAT RESULT FROM THE USE OF, INABILITY TO USE, OR UNAVAILABILITY OF THE SERVICES, REGARDLESS OF THE FORM OF ACTION AND WHETHER OR NOT WE KNEW THAT SUCH DAMAGE MAY HAVE BEEN INCURRED. IN NO EVENT WILL WE BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY DAMAGE, LOSS OR INJURY RESULTING FROM HACKING, TAMPERING, VIRUS TRANSMISSION OR OTHER UNAUTHORIZED ACCESS OR USE OF THE SERVICES, YOUR SemitePay ACCOUNT, OR ANY INFORMATION CONTAINED THEREIN. IN NO EVENT WILL OUR LIABILITY FOR ANY DAMAGES ARISING IN CONNECTION WITH THE SERVICES EXCEED THE FEES EARNED BY US IN CONNECTION WITH YOUR USE OF THE SERVICES DURING THE 6 MONTH PERIOD IMMEDIATELY PRECEDING THE EVENT GIVING RISE TO THE CLAIM FOR LIABILITY. THE FOREGOING LIMITATIONS OF LIABILITY SHALL APPLY TO THE FULLEST EXTENT PERMITTED BY LAW IN THE APPLICABLE JURISDICTION.&lt;/p&gt;\r\n\r\n&lt;h3 id=&quot;miscellaneous&quot;&gt;Miscellaneous&lt;/h3&gt;\r\n\r\n&lt;h4&gt;Taxes&lt;/h4&gt;\r\n\r\n&lt;p&gt;You are responsible for determining any and all taxes assessed, incurred, or required to be collected, paid, or withheld for any reason in connection your use of our software and services (Taxes). You also are solely responsible for collecting, withholding, reporting, and remitting correct Taxes to the appropriate tax authority. We are not obligated to, nor will we determine whether Taxes apply, or calculate, collect, report, or remit any Taxes to any tax authority arising from any transaction.&lt;/p&gt;\r\n\r\n&lt;p&gt;If in a given calendar year you receive (i) more than $20,000 in gross amount of payments and (ii) more than 200 payments, SemitePay will report annually to the Internal Revenue Service, as required by law, your name, address, tax identification number (such as a social security number, or employer identification number), the total dollar amount of the payments you receive in a calendar year and the total dollar amount of the payments you receive for each month in a calendar year.&lt;/p&gt;\r\n\r\n&lt;h4&gt;Privacy Policy&lt;/h4&gt;\r\n\r\n&lt;p&gt;Please see our Privacy Policy for information regarding how we collect and use information. The Privacy Policy is part of these Terms, so please make sure that you read it.&lt;/p&gt;\r\n\r\n&lt;h4&gt;Assignment&lt;/h4&gt;\r\n\r\n&lt;p&gt;You may not transfer or assign these Terms, or any rights granted by these Terms. You agree and acknowledge that we may assign or transfer these Terms.&lt;/p&gt;\r\n\r\n&lt;h4&gt;Severability&lt;/h4&gt;\r\n\r\n&lt;p&gt;Should any provision of these Terms be determined to be invalid or unenforceable under any law, rule, or regulation, such determination will not affect the validity or enforceability of any other provision of this Agreement.&lt;/p&gt;\r\n\r\n&lt;h4&gt;Waivers&lt;/h4&gt;\r\n\r\n&lt;p&gt;Our failure to assert any right or provision in these Terms shall not constitute a waiver of such right or provision, and no waiver of any term shall be deemed a further or continuing waiver of such or other term.&lt;/p&gt;\r\n\r\n&lt;h4&gt;Entire Agreement&lt;/h4&gt;\r\n\r\n&lt;p&gt;These Terms, including the Privacy Policy referenced herein, represent the entire understanding between us and you with respect to the matters discussed. Headings are included for convenience only, and shall not be considered in interpreting these Terms.&lt;/p&gt;\r\n\r\n&lt;h4&gt;Notices&lt;/h4&gt;\r\n\r\n&lt;p&gt;You agree to accept communications from us in an electronic format, and agree that all terms, conditions, agreements, notices, disclosures or other communications that we provide to you electronically will be considered to be “in writing.”&lt;/p&gt;\r\n\r\n&lt;h4&gt;Governing Law; Arbitration&lt;/h4&gt;\r\n\r\n&lt;p&gt;These Terms will be governed by and construed in accordance with the laws of the Turkish Repulic of Northern Cyprus (TRNC) without reference to conflict of law or choice of law provisions, and applicable federal law (including the Federal Arbitration Act). If a disagreement or dispute in any way involves the Services or these Terms and cannot be resolved between you and us with reasonable effort, the disagreement or dispute shall be resolved exclusively by final and binding administration by the American Arbitration Association (AAA), and will be conducted before a single arbiter pursuant to the applicable Rules and Procedures established by the AAA. You agree that the arbitration shall be held in the State of Georgia, or at any other location that is mutually agreed upon by you and us. You agree that the arbiter will apply the laws of the State of Georgia consistent with the Federal Arbitration Act, and will honor and agree to all applicable statutes of limitation. You agree that, unless prohibited by law, there shall be no authority for any claims to be arbitrated on a class or representative basis, and arbitration will only decide a dispute between you and us. Arbitration proceedings must be initiated within 1 year after the disagreement or dispute arises. If any part of this Arbitration clause is later deemed invalid as a matter of law, then the remaining portions of this section shall remain in effect, except that in no case shall there be a class arbitration.&lt;/p&gt;\r\n\r\n&lt;h4&gt;Amendment&lt;/h4&gt;\r\n\r\n&lt;p&gt;We may update or change these Terms from time to time. Except as otherwise provided in these Terms, we will notify you of any changes by electronic mail or by posting a link to the amended Terms on our website. If you continue to use the Services after we provide notice of such changes, your continued use constitutes an acceptance of the amended Terms and an agreement to be bound by them. If you do not agree to the amended Terms, you must close your SemitePay account and discontinue your use of the Services.&lt;/p&gt;\r\n\r\n&lt;h4&gt;Force Majeure&lt;/h4&gt;\r\n\r\n&lt;p&gt;Neither you nor we will be liable for delays in processing or other nonperformance caused by such events as fires, telecommunications, utility, or power failures, equipment failures, labor strife, riots, war, nonperformance of our vendors or suppliers, acts of God, or other causes over which the respective party has no reasonable control; provided that the party has procedures reasonably suited to avoid the effects of such acts.&lt;/p&gt;\r\n\r\n&lt;h4&gt;Survival&lt;/h4&gt;\r\n\r\n&lt;p&gt;The provisions of Sections 2.2, 3.3, 3.4, 4.2, 5, 6, 7, 8.1, 8.5, 8.7, 8.8, 9 (including all subsections), 11, 12, 13, and 14.7 shall survive the termination of these Terms.&lt;/p&gt;\r\n\r\n&lt;p&gt;You agree that the person signing below has the authority to sign the Terms and to bind you, and you acknowledge and agree that you: (a) have read and understand the Terms; (b) intend to form a legally binding contract; and (c) will abide by all the Terms.&lt;/p&gt;\r\n\r\n&lt;p&gt;&amp;nbsp;&lt;/p&gt;\r\n\r\n&lt;p&gt;&lt;br /&gt;\r\n[NAME OF MERCHANT]&lt;br /&gt;\r\n&lt;br /&gt;\r\nBy:&lt;br /&gt;\r\nName:&lt;br /&gt;\r\nTitle:&lt;br /&gt;\r\nDate:&lt;/p&gt;\r\n'),(83,1,'Merchant Terms Of Use - CC','&lt;div class=&quot;legal-sidebar hidden-print &quot; role=&quot;complementary&quot;&gt;&lt;small class=&quot;section-block-header-topic&quot;&gt;Contents&lt;/small&gt;\r\n&lt;ul class=&quot;nav&quot;&gt;\r\n	&lt;li&gt;&lt;a href=&quot;#terms-of-use&quot;&gt;Terms of Use&lt;/a&gt;\r\n	&lt;ul class=&quot;nav&quot;&gt;\r\n		&lt;li&gt;&lt;a href=&quot;#the-services&quot;&gt;The Services&lt;/a&gt;&lt;/li&gt;\r\n		&lt;li&gt;&lt;a href=&quot;#registration&quot;&gt;Registration&lt;/a&gt;&lt;/li&gt;\r\n		&lt;li&gt;&lt;a href=&quot;#your-sales&quot;&gt;Your Sales&lt;/a&gt;&lt;/li&gt;\r\n		&lt;li&gt;&lt;a href=&quot;#third-parties&quot;&gt;Third Parties&lt;/a&gt;&lt;/li&gt;\r\n		&lt;li&gt;&lt;a href=&quot;#collect-use-share&quot;&gt;Information&lt;/a&gt;&lt;/li&gt;\r\n		&lt;li&gt;&lt;a href=&quot;#our-ownership&quot;&gt;Ownership&lt;/a&gt;&lt;/li&gt;\r\n		&lt;li&gt;&lt;a href=&quot;#advertising&quot;&gt;Advertising&lt;/a&gt;&lt;/li&gt;\r\n		&lt;li&gt;&lt;a href=&quot;#fees-and-settlement&quot;&gt;Fees &amp;amp; Settlement&lt;/a&gt;&lt;/li&gt;\r\n		&lt;li&gt;&lt;a href=&quot;#refunds-and-adjustments&quot;&gt;Refunds &amp;amp; Adjustments&lt;/a&gt;&lt;/li&gt;\r\n		&lt;li&gt;&lt;a href=&quot;#account-termination&quot;&gt;Account Termination&lt;/a&gt;&lt;/li&gt;\r\n		&lt;li&gt;&lt;a href=&quot;#indemnification&quot;&gt;Indemnification&lt;/a&gt;&lt;/li&gt;\r\n		&lt;li&gt;&lt;a href=&quot;#no-warrenties&quot;&gt;No Warranties&lt;/a&gt;&lt;/li&gt;\r\n		&lt;li&gt;&lt;a href=&quot;#limitation-of-liability&quot;&gt;Liability&lt;/a&gt;&lt;/li&gt;\r\n		&lt;li&gt;&lt;a href=&quot;#miscellaneous&quot;&gt;Miscellaneous&lt;/a&gt;&lt;/li&gt;\r\n	&lt;/ul&gt;\r\n	&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;/div&gt;\r\n'),(84,1,'Money Laundering','&lt;h2&gt;Money Laundering Prevention&lt;/h2&gt;\r\n\r\n&lt;p&gt;&lt;strong&gt;What am I asked to do?&lt;/strong&gt;&lt;/p&gt;\r\n\r\n&lt;p&gt;You may find that you are asked to confirm your identity and other personal details. Skrill has established special verification systems involving your bank account or payment card to prove your identity. To safeguard the integrity of our payment system, your Skrill account may also be subject to periodic transaction limits depending on your user status.&lt;/p&gt;\r\n\r\n&lt;p&gt;&lt;strong&gt;When?&lt;/strong&gt;&lt;/p&gt;\r\n\r\n&lt;p&gt;You could be asked to confirm your identity whether you are applying to be a new customer or have been a customer for some time. While our identity verification systems are designed to minimise any inconvenience for you, the verification process may take several days to complete.&lt;/p&gt;\r\n\r\n&lt;p&gt;&lt;strong&gt;Why?&lt;/strong&gt;&lt;/p&gt;\r\n\r\n&lt;p&gt;Crime and terrorism need cash. Criminals turn the &quot;dirty&quot; cash made from drug trafficking, smuggling, and robbery into clean money by using false identities or taking the names of innocent people - like you. Making sure that people are who they say they are is essential in the fight against crime and terrorism. This does not mean in any way that suspicion is falling on you. Any information about your identity is held confidentially and will help stop your identity being used falsely.&lt;/p&gt;\r\n\r\n&lt;p&gt;&lt;strong&gt;Who is involved?&lt;/strong&gt;&lt;/p&gt;\r\n\r\n&lt;p&gt;HM Government and all organisations involved in financial services. All are united in their determination to stop the spread of financial crime as part of the international effort to crack down on financial crime - protecting us all against crime and terrorism.&lt;/p&gt;\r\n\r\n&lt;p&gt;&lt;strong&gt;Your co-operation is vital to the successful fight against crime and terrorism.&lt;/strong&gt;&lt;/p&gt;\r\n\r\n&lt;p&gt;&lt;strong&gt;What the Turkish Republic of Northern Cyprus (TRNC) law requires:&lt;/strong&gt;&lt;/p&gt;\r\n\r\n&lt;ul&gt;\r\n	&lt;li&gt;We may be required to verify your identity and address.&lt;/li&gt;\r\n	&lt;li&gt;We are required to keep full records of all transactions together with identification provided.&lt;/li&gt;\r\n	&lt;li&gt;We are required to monitor any unusual or suspicious transactions of any size.&lt;/li&gt;\r\n	&lt;li&gt;We have a legal obligation to report to the Serious Organised Crime Agency (SOCA) any suspicious transaction.&lt;/li&gt;\r\n&lt;/ul&gt;\r\n'),(85,1,'Privacy Policy','&lt;h2 id=&quot;privacy-policy&quot;&gt;Privacy Policy&lt;/h2&gt;\r\n\r\n&lt;p&gt;This policy describes the ways we collect, store, use and protect your personal information. You accept this policy when you sign up for or use our products, services or any other features, technologies or functionalities offered by us on our website or through any other means. We may amend this policy at any time by posting a revised version on our website. The revised version will be effective at the time we post it. In addition, if the revised version includes a substantial change, we will provide you with 30 days prior notice by posting notice of the change on the &quot;Privace Policy&quot; area of our website.&lt;/p&gt;\r\n\r\n&lt;h3 id=&quot;info-collection&quot;&gt;How we collect information about you&lt;/h3&gt;\r\n\r\n&lt;p&gt;When you visit the SemitePay website or use the SemitePay Services, we collect your IP address and standard web log information, such as your browser type and the pages you accessed on our website.&lt;/p&gt;\r\n\r\n&lt;p&gt;If you open an account or use the SemitePay Services, we may collect the following types of information:&lt;/p&gt;\r\n\r\n&lt;ul&gt;\r\n	&lt;li&gt;Contact information: your name, address, phone, email, Skype ID and other similar information.&lt;/li&gt;\r\n	&lt;li&gt;Financial information: the full bank account numbers that you link to your SemitePay account or give us when you use the SemitePay Services.&lt;/li&gt;\r\n&lt;/ul&gt;\r\n\r\n&lt;p&gt;Before permitting you to use the SemitePay Services, we may require you to provide additional information we can use to verify your identity or address or manage risk, such as your date of birth, social security number or other information. We may also obtain information about you from third parties such as credit bureaus and identity verification services.&lt;/p&gt;\r\n\r\n&lt;p&gt;When you are using the SemitePay Services, we collect information about your transactions and your other activities on our website or using the SemitePay Services and we may collect information about your computer or other access device for fraud prevention purposes.&lt;/p&gt;\r\n\r\n&lt;h3 id=&quot;cookies&quot;&gt;How we use cookies&lt;/h3&gt;\r\n\r\n&lt;p&gt;When you access our website, we, or companies we hire to track how our website is used, may place small data files called &quot;cookies&quot; on your computer. We and our service providers also use cookies to customize the SemitePay Services, content and advertising; measure promotional effectiveness, and promote trust and safety.&lt;/p&gt;\r\n\r\n&lt;p&gt;We send a &quot;session cookie&quot; to your computer when you log in to your account or otherwise use the SemitePay Services. This type of cookie helps us to recognize you if you visit multiple pages on our site during the same session, so that we do not need to ask you for your password on each page. Once you log out or close your browser, this cookie expires and no longer has any effect.&lt;/p&gt;\r\n\r\n&lt;p&gt;We also use longer-lasting cookies for other purposes such as to display your e-mail address on our sign-in form, so that you don\'t need to retype the e-mail address each time you log in to your account.&lt;/p&gt;\r\n\r\n&lt;p&gt;We encode our cookies so that only we can interpret the information stored in them. You are free to decline our cookies if your browser permits, but doing so may interfere with your use of our website. We may also collect information about your computer or other access device to mitigate risk and for fraud prevention purposes.&lt;/p&gt;\r\n\r\n&lt;p&gt;You may encounter cookies from third parties when using the SemitePay Services on websites that we do not control (for example, if you view a web page created by a third party or use an application developed by a third party, there may be a cookie placed by that web page or application.)&lt;/p&gt;\r\n\r\n&lt;h3 id=&quot;protect-and-store&quot;&gt;How we protect and store personal information&lt;/h3&gt;\r\n\r\n&lt;p&gt;Throughout this policy, we use the term &quot;personal information&quot; to describe information that can be associated with a specific person and can be used to identify that person. We do not consider personal information to include information that has been anonymized so that it does not identify a specific user.&lt;/p&gt;\r\n\r\n&lt;p&gt;We store and process your personal information on our computers in the US and elsewhere in the world where SemitePay facilities are located, and we protect it by maintaining physical, electronic and procedural safeguards in compliance with applicable US federal and state regulations. We use computer safeguards such as firewalls and data encryption, we enforce physical access controls to our buildings and files, and we authorize access to personal information only for those employees who require it to fulfill their job responsibilities.&lt;/p&gt;\r\n\r\n&lt;h3 id=&quot;info-use&quot;&gt;How we use the personal information we collect&lt;/h3&gt;\r\n\r\n&lt;p&gt;Our primary purpose in collecting personal information is to provide you with a secure, smooth, efficient, and customized experience. We may use your personal information to:&lt;/p&gt;\r\n\r\n&lt;ul&gt;\r\n	&lt;li&gt;provide the SemitePay Services and customer support you request;&lt;/li&gt;\r\n	&lt;li&gt;process transactions and send notices about your transactions;&lt;/li&gt;\r\n	&lt;li&gt;resolve disputes, collect fees, and troubleshoot problems;&lt;/li&gt;\r\n	&lt;li&gt;prevent potentially prohibited or illegal activities, and enforce our User Agreement;&lt;/li&gt;\r\n	&lt;li&gt;customize, measure, and improve the SemitePay Services and the content and layout of our website and applications;&lt;/li&gt;\r\n	&lt;li&gt;deliver targeted marketing, service update notices, and promotional offers based on your communication preferences;&lt;/li&gt;\r\n	&lt;li&gt;compare information for accuracy and verify it with third parties.&lt;/li&gt;\r\n&lt;/ul&gt;\r\n\r\n&lt;h3 id=&quot;marketing&quot;&gt;Marketing&lt;/h3&gt;\r\n\r\n&lt;p&gt;We do not sell or rent your personal information to third parties for their marketing purposes without your explicit consent. We may combine your information with information we collect from other companies and use it to improve and personalize the SemitePay Services, content and advertising. If you do not wish to receive marketing communications from us or participate in our ad-customization programs, simply indicate your preference by logging into your account and going to the Profile subtab under the My Account tab and adjusting your preferences under Account Information, or by following the directions provided with the communication or advertisement.&lt;/p&gt;\r\n\r\n&lt;h3 id=&quot;info-sharing&quot;&gt;How we share personal information with other SemitePay users&lt;/h3&gt;\r\n\r\n&lt;p&gt;To process your payments, we may share some of your personal information with the person or company that you are paying or that is paying you. Your contact information, date of sign-up, the number of payments you have received from verified SemitePay users, and whether you have verified control of a bank account are provided to other SemitePay users who you transact with through SemitePay. In addition, this and other information may also be shared with third parties when you use these third parties to access the SemitePay Services. Unless you have agreed to it, these third parties are not allowed to use this information for any purpose other than to enable the SemitePay Services.&lt;/p&gt;\r\n\r\n&lt;p&gt;If you are buying goods or services and pay through SemitePay, we may also provide the seller with your confirmed credit card billing address to help complete your transaction with the seller. The seller is not allowed to use this information to market their services to you unless you have agreed to it. If an attempt to pay your seller fails, or is later invalidated, we may also provide your seller with details of the unsuccessful payment. To facilitate dispute resolutions, we may provide a buyer with the sellers address so that goods can be returned to the seller.&lt;/p&gt;\r\n\r\n&lt;p&gt;We work with third parties, including merchants, to enable them to accept or facilitate payments from or to you using SemitePay. In doing so, a third party may share information about you with us, such as your email address or mobile phone number to inform you that a payment is sent to you or when you attempt to pay that merchant or through that third party. We use this information to confirm to that you are a SemitePay customer and that SemitePay as a form of payment can be enabled, or where a payment is sent to you to send you notification that you have received a payment. Also, if you request that we validate your status as a SemitePay customer with a third party, we will do so. Please note that merchants you buy from and contract with have their own privacy policies, and SemitePay may not be held responsible for their operations, including, but not limited to, their information practices.&lt;/p&gt;\r\n'),(86,1,'Privacy Policy - CC','&lt;div class=&quot;legal-sidebar hidden-print &quot; role=&quot;complementary&quot;&gt;&lt;small class=&quot;section-block-header-topic&quot;&gt;Contents&lt;/small&gt;\r\n&lt;ul class=&quot;nav&quot;&gt;\r\n	&lt;li&gt;&lt;a href=&quot;#privacy-policy&quot;&gt;Privacy Policy&lt;/a&gt;\r\n	&lt;ul class=&quot;nav&quot;&gt;\r\n		&lt;li&gt;&lt;a href=&quot;#info-collection&quot;&gt;Information Collection&lt;/a&gt;&lt;/li&gt;\r\n		&lt;li&gt;&lt;a href=&quot;#cookies&quot;&gt;Cookies&lt;/a&gt;&lt;/li&gt;\r\n		&lt;li&gt;&lt;a href=&quot;#protect-and-store&quot;&gt;Information Protection&lt;/a&gt;&lt;/li&gt;\r\n		&lt;li&gt;&lt;a href=&quot;#info-use&quot;&gt;Information Usage&lt;/a&gt;&lt;/li&gt;\r\n		&lt;li&gt;&lt;a href=&quot;#marketing&quot;&gt;Marketing&lt;/a&gt;&lt;/li&gt;\r\n		&lt;li&gt;&lt;a href=&quot;#info-sharing&quot;&gt;Information Sharing&lt;/a&gt;&lt;/li&gt;\r\n	&lt;/ul&gt;\r\n	&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;/div&gt;\r\n'),(87,1,'About Us','&lt;p&gt;About Us&lt;/p&gt;\r\n'),(88,1,'A payment gateway that fits right in.','&lt;p&gt;A powerful API, 7 ready-made libraries, plugins for 22 e-commerce solutions, and instant integration into the world’s best e-commerce web services. &lt;a href=&quot;#&quot;&gt;Integrations ›&lt;/a&gt;&lt;/p&gt;\r\n'),(89,1,'Charge $1, get $1.','&lt;p&gt;Instant conversion, no transaction fee, and bank deposits in US Dollars, Euros, GBP, CAD and more. We take the bitcoin exchange rate risk, your customers get the best rate on the market, and you get a payment you can count on, every time. &lt;a href=&quot;#&quot;&gt;Conversion &amp;amp; Bank Deposit ›&lt;/a&gt;&lt;/p&gt;\r\n'),(91,1,'Scale globally.','&lt;p&gt;Grow with the most reliable infrastructure in the industry, available everywhere. Offer experiences in 40 languages, instantly price in 150 currencies, and leverage SemitePay’s quickly growing, international team to get an edge.&lt;/p&gt;\r\n'),(96,1,'SemitePay, done right.','&lt;p&gt;All of our systems are based on open standards and work for all SemitePayment users, no accounts needed.&lt;/p&gt;\r\n'),(97,1,'Stay ahead of the curve.','&lt;p&gt;Our team contributes and develops innovative standards to make bitcoin work better for our customers.&lt;/p&gt;\r\n'),(98,1,'Work with a center of innovation.','&lt;p&gt;We\'re constantly recruiting bitcoin developers and contributing to open-source projects.&lt;/p&gt;\r\n'),(99,1,'You’re in good company.','We protect our merchants by maintaining enterprise-grade vetting and compliance standards. More than just a name and email, each of our merchants is regularly reviewed according to industry standards.'),(100,1,'We’ve got your back.','&lt;p&gt;We work with regulators to ensure their needs are met, and we provide you with the tools and reporting you need to be a market leader- without the legal uncertainty.&lt;/p&gt;\r\n'),(90,1,'Launch with confidence.','&lt;p&gt;Get world-class engineering services and client operations teams to get you on the right track, with phone support and dedicated account manager options available.&lt;/p&gt;\r\n'),(101,1,'Start accepting Semite Payment today.','&lt;p&gt;&lt;a class=&quot;btn btn-primary&quot; data-no-instant=&quot;&quot; href=&quot;/register&quot; role=&quot;button&quot;&gt;Accept Semite Payment&amp;nbsp;&amp;nbsp;›&lt;/a&gt;&lt;/p&gt;\r\n'),(102,1,'Pricing','&lt;p&gt;This page is currently updating.&lt;/p&gt;\r\n'),(103,1,'Developer','&lt;p&gt;&lt;span style=&quot;font-size: 13px;&quot;&gt;This page is currently updating.&lt;/span&gt;&lt;/p&gt;\r\n'),(104,1,'Registration Success','&lt;p&gt;Dear Customer,&lt;/p&gt;\r\n\r\n&lt;p&gt;Congratulations! Your new {config_name} account has been successfully created!&lt;/p&gt;\r\n\r\n&lt;p&gt;You can now take advantage of member privileges to enhance your online shopping experience with us.&lt;/p&gt;\r\n\r\n&lt;p&gt;If you have ANY questions about the operation of this online shop, please email the &lt;a href=&quot;mailto:support@semitepayment.com&quot;&gt;Support&lt;/a&gt;.&lt;/p&gt;\r\n\r\n&lt;p&gt;Your {config_name} Account will be activated in 24hrs.&lt;/p&gt;\r\n\r\n&lt;p&gt;{config_name} Team.&lt;/p&gt;\r\n\r\n&lt;p&gt;&lt;a class=&quot;btn btn-primary&quot; data-no-instant=&quot;&quot; href=&quot;/&quot; role=&quot;button&quot;&gt;Continue&amp;nbsp;&amp;nbsp;›&lt;/a&gt;&lt;/p&gt;\r\n'),(105,1,'Merchant Account Application Requirements','&lt;p&gt;The merchant account application review is a fairly straightforward process that typically takes a day or two to complete, but more often than not it drags on for a bit longer, due to insufficient paperwork. Merchants are often surprised with the amount of documentation needed and are not always prepared to produce all of it at once. Additionally, there have been some recent changes in the list of requirements for new applicants, so I thought that a fresh overview is in order.&lt;/p&gt;\r\n\r\n&lt;p&gt;&lt;strong&gt;General Requirements for Merchant Account&lt;/strong&gt;&lt;/p&gt;\r\n\r\n&lt;p&gt;All applicants for merchant accounts need to be compliant with the following general requirements:&lt;/p&gt;\r\n\r\n&lt;ul&gt;\r\n	&lt;li&gt;&lt;strong&gt;Legal presence&lt;/strong&gt; in their countires. All merchant account applicants must be legally incorporated as businesses in their country. or at least registered with the local city or town and obtain a “Doing Business As” (DBA) name.&lt;/li&gt;\r\n	&lt;li&gt;&lt;strong&gt;Physical presence&lt;/strong&gt; in their countries. All applicants must maintain a physical address in their countries that can be verified. A P.O. Box is insufficient.&lt;/li&gt;\r\n	&lt;li&gt;&lt;strong&gt;Bank account.&lt;/strong&gt; The bank account into which the merchant would have their funds withdrawed&amp;nbsp;must be set up with a bank.&lt;/li&gt;\r\n&lt;/ul&gt;\r\n\r\n&lt;p&gt;&lt;em&gt;Once these requirements are met, the merchant can proceed with the application process.&lt;/em&gt;&lt;/p&gt;\r\n\r\n&lt;p&gt;&lt;strong&gt;Paperwork Required of Merchant Account Applicants&lt;/strong&gt;&lt;/p&gt;\r\n\r\n&lt;p&gt;The required application documents will vary depending on the applicant’s &lt;a href=&quot;#&quot;&gt;risk categorization&lt;/a&gt;, which is determined based on a list of factors, including line of business, monthly processing volumes, previous processing experience, etc. However, all applicants will be required to provide the following documents:&lt;/p&gt;\r\n\r\n&lt;ul&gt;\r\n	&lt;li&gt;&lt;strong&gt;Application form.&lt;/strong&gt; A form that collects basic information about both the applicant business and its principals, including address (business and personal), tax ID, phone number, email address, web address, bank account information, processing volumes, average sales amount, etc. The pricing agreement may be part of the application form or separate from it.&lt;/li&gt;\r\n	&lt;li&gt;&lt;strong&gt;Personal guarantee.&lt;/strong&gt; Processors look to limit their liability for fraudulent transactions by requiring the principals of all privately held businesses to provide a personal guarantee. Publicly traded and non-profit entities are exempt from this requirement.&lt;/li&gt;\r\n	&lt;li&gt;Articles of Incorporation. Incorporated entities are required to provide a copy of their incorporation paperwork.&lt;/li&gt;\r\n	&lt;li&gt;&lt;strong&gt;Business license.&lt;/strong&gt; If the applicant business requires some form of a permit or license, either a federal or a state one, it will have to be submitted.&lt;/li&gt;\r\n	&lt;li&gt;&lt;strong&gt;Voided check.&lt;/strong&gt; A voided check is needed for the bank account into which the merchant’s funds will be deposited. It must be a permanent check, i.e. it must have the business name pre-printed on it. If a permanent check is unavailable, it can be substituted with a bank letter stating the bank account details and signed by a bank manager.&lt;/li&gt;\r\n	&lt;li&gt;&lt;strong&gt;W-9 form.&lt;/strong&gt; This is the application form for a federal Tax ID. It can be substituted with the SS-4 form, with which the Tax Id is received.&lt;/li&gt;\r\n&lt;/ul&gt;\r\n\r\n&lt;p&gt;The following paperwork may be required of applicants that are categorized as higher risk&lt;/p&gt;\r\n\r\n&lt;ul&gt;\r\n	&lt;li&gt;&lt;strong&gt;Business financial statements.&lt;/strong&gt; Typically required for the preceding two fiscal years.&lt;/li&gt;\r\n	&lt;li&gt;&lt;strong&gt;Personal financial statements.&lt;/strong&gt; Also typically required for the two latest years.&lt;/li&gt;\r\n	&lt;li&gt;&lt;strong&gt;Processing statements.&lt;/strong&gt; Required of merchants with previous processing experience, typically for the latest three or six months. Most processors will not consider applications from certain high-risk business types if they lack processing experience.&lt;/li&gt;\r\n&lt;/ul&gt;\r\n\r\n&lt;p&gt;As you can see, these are all documents that should not be difficult to produce. If the processor receives everything it needs at once, there should be no delay, so just double check your paperwork before faxing or emailing it.&lt;/p&gt;\r\n');
/*!40000 ALTER TABLE `engine4_content_description` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `engine4_content_revision`
--

DROP TABLE IF EXISTS `engine4_content_revision`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `engine4_content_revision` (
  ...
  `message` text,
  PRIMARY KEY (`revision_id`,`content_id`,`author`)
) ENGINE=MyISAM AUTO_INCREMENT=86 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `engine4_content_revision`
--

LOCK TABLES `engine4_content_revision` WRITE;
/*!40000 ALTER TABLE `engine4_content_revision` DISABLE KEYS */;
INSERT INTO `engine4_content_revision` VALUES (85,88,1,'2014-08-02 15:07:33','127.0.0.1',''),(84,88,1,'2014-08-02 15:07:19','127.0.0.1',''),(83,88,1,'2014-08-02 15:07:00','127.0.0.1','');
/*!40000 ALTER TABLE `engine4_content_revision` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `engine4_content_to_application`
--

DROP TABLE IF EXISTS `engine4_content_to_application`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `engine4_content_to_application` (
  `content_id` int(11) NOT NULL,
  `application_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`content_id`,`application_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `engine4_content_to_application`
--

LOCK TABLES `engine4_content_to_application` WRITE;
/*!40000 ALTER TABLE `engine4_content_to_application` DISABLE KEYS */;
INSERT INTO `engine4_content_to_application` VALUES (51,0),(52,0),(53,0),(54,0),(55,0),(56,0),(57,0),(58,0),(59,0),(60,0),(61,0),(62,0),(63,0),(64,0),(65,0),(66,0),(67,0),(68,0),(69,0),(70,0),(71,0),(72,0),(73,0),(74,0),(75,0),(76,0),(77,0),(78,0),(79,0),(80,0),(81,0),(82,0),(83,0),(84,0),(85,0),(86,0),(87,0),(88,0),(89,0),(90,0),(91,0),(92,0),(93,0),(94,0),(95,0),(96,0),(97,0),(98,0),(99,0),(100,0),(101,0),(102,0),(103,0),(104,0),(105,0);
/*!40000 ALTER TABLE `engine4_content_to_application` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `engine4_content_type`
--

DROP TABLE IF EXISTS `engine4_content_type`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `engine4_content_type` (
...
--
-- Dumping data for table `engine4_content_type`
--

LOCK TABLES `engine4_content_type` WRITE;
/*!40000 ALTER TABLE `engine4_content_type` DISABLE KEYS */;
INSERT INTO `engine4_content_type` VALUES (17,'Content Control'),(16,'Full Content'),(15,'Featured'),(18,'Image');
/*!40000 ALTER TABLE `engine4_content_type` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `engine4_content_type_field`
--

DROP TABLE IF EXISTS `engine4_content_type_field`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `engine4_content_type_field` (
  `content_type_field_id` int(11) NOT NULL AUTO_INCREMENT,
  `content_type_id` int(11) NOT NULL,
  `field` varchar(45) NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`content_type_field_id`,`content_type_id`,`field`)
) ENGINE=MyISAM AUTO_INCREMENT=82 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `engine4_content_type_field`
--

LOCK TABLES `engine4_content_type_field` WRITE;
/*!40000 ALTER TABLE `engine4_content_type_field` DISABLE KEYS */;
INSERT INTO `engine4_content_type_field` VALUES (75,17,'description',1),(81,16,'description',1),(71,15,'link',1),(80,16,'title',1),(79,16,'image',1),(70,15,'image',1),(69,15,'description',1),(68,15,'title',1),(77,18,'image',1),(78,18,'description',1);
/*!40000 ALTER TABLE `engine4_content_type_field` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `engine4_currency` VALUES (1,'Pound Sterling','GBP','£','','2',0.27169999,1,'2014-10-05 07:21:17'),(2,'US Dollar','USD','$','','2',0.43399999,1,'2014-10-05 07:21:17'),(3,'Euro','EUR','','€','2',0.34670001,1,'2014-10-05 07:21:17'),(4,'Turkish Lira','TRY','TL','','2',1.00000000,1,'2014-10-05 07:21:45');
...
INSERT INTO `engine4_customer` VALUES (39,'Ahmet','Gudenoglu','ahmet.gudenoglu@semitepayment.com',NULL,'0000-00-00','','','','089c031104ea9a5da026fefb1b2416fafecbe10d','006fb97cd','',0,18,2,'127.0.0.1',1,0,'','2014-08-31 09:22:29');
/*!40000 ALTER TABLE `engine4_customer` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `engine4_customer_account`
--

DROP TABLE IF EXISTS `engine4_customer_account`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `engine4_customer_account` (
  `account_number` varchar(11) NOT NULL,
  `customer_id` int(11) NOT NULL,
  `iban` varchar(24) NOT NULL,
  `swift_bic` varchar(8) NOT NULL,
  `v_card_number` varchar(19) NOT NULL DEFAULT '0000-0000-0000-0000',
  `v_card_ccv` int(3) NOT NULL DEFAULT '0',
  `date_expire` date NOT NULL DEFAULT '0000-00-00',
  `balance` decimal(15,4) DEFAULT '0.0000',
  `decline_cvc` tinyint(1) NOT NULL DEFAULT '0',
  `decline_zip` tinyint(1) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `engine4_customer_account`
--

LOCK TABLES `engine4_customer_account` WRITE;
/*!40000 ALTER TABLE `engine4_customer_account` DISABLE KEYS */;
INSERT INTO `engine4_customer_account` VALUES ('5943-2873-6',39,'SP92006040405928-0596-79','SPCYPP','5944-1841-3056-4115',5921,'2016-08-31',0.0000,0,0,NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `engine4_customer_account` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `engine4_customer_bank`
--

DROP TABLE IF EXISTS `engine4_customer_bank`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `engine4_customer_bank` (
  `customer_bank_id` int(11) NOT NULL AUTO_INCREMENT,
  `customer_id` int(11) NOT NULL,
  `bank_name` varchar(64) NOT NULL,
  `settlement_currency` varchar(4) NOT NULL,
  `account_holder` varchar(64) NOT NULL,
  `iban` varchar(26) NOT NULL,
  `swift` varchar(8) NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`customer_bank_id`,`customer_id`)
) ENGINE=MyISAM AUTO_INCREMENT=77 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `engine4_customer_bank`
--

LOCK TABLES `engine4_customer_bank` WRITE;
/*!40000 ALTER TABLE `engine4_customer_bank` DISABLE KEYS */;
INSERT INTO `engine4_customer_bank` VALUES (76,39,'UNIVERSAL BANK','TRY','AHMET GUDENOGLU','TR12345678987654','TGBATRIS',18);
/*!40000 ALTER TABLE `engine4_customer_bank` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `engine4_customer_card`
--

DROP TABLE IF EXISTS `engine4_customer_card`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `engine4_customer_card` (
  ...
  `date_expire` varchar(5) NOT NULL DEFAULT '00-00',
  `status` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`customer_card_id`,`customer_id`)
) ENGINE=MyISAM AUTO_INCREMENT=12 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `engine4_customer_card`
--
...
CREATE TABLE `engine4_customer_group` (
  ...
  `legal` int(1) NOT NULL,
  `legal_required` int(1) NOT NULL,
...
INSERT INTO `engine4_customer_group` VALUES (1,1,1,1,1,1,1,1,1,5,1),(2,0,1,0,1,0,1,0,0,5,2),(3,0,1,1,1,1,1,1,1,5,3),(4,0,1,1,1,1,1,1,1,5,4),(5,0,1,1,1,1,1,1,1,5,5),(6,0,1,1,1,1,1,1,1,5,6);
...
INSERT INTO `engine4_customer_group_description` VALUES (1,1,'Corporation','Semite Pay Corporation Account'),(2,1,'Individual / Sole Proprietorship','Semite Pay Individual / Sole Proprietorship eWallet Account'),(3,1,'Non-profit','Non-profit'),(4,1,'Partnership','Partnership'),(5,1,'LLC',''),(6,1,'Gambling','Semite Payment Gambling Account');
...
INSERT INTO `engine4_customer_ip` VALUES (15,39,'127.0.0.1','2014-08-31 09:41:23');
...
--
-- Table structure for table `engine4_customer_statement`
--

DROP TABLE IF EXISTS `engine4_customer_statement`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `engine4_customer_statement` (
  `customer_id` int(11) NOT NULL,
  `mail_me` tinyint(1) NOT NULL DEFAULT '0',
  `mail_customer` tinyint(1) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `engine4_customer_statement`
--

LOCK TABLES `engine4_customer_statement` WRITE;
/*!40000 ALTER TABLE `engine4_customer_statement` DISABLE KEYS */;
/*!40000 ALTER TABLE `engine4_customer_statement` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `engine4_customer_transaction` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`customer_transaction_id`,`transaction_id`)
...
--
-- Table structure for table `engine4_customer_upload`
--

DROP TABLE IF EXISTS `engine4_customer_upload`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `engine4_customer_upload` (
...
--
-- Dumping data for table `engine4_customer_upload`
--

LOCK TABLES `engine4_customer_upload` WRITE;
/*!40000 ALTER TABLE `engine4_customer_upload` DISABLE KEYS */;
/*!40000 ALTER TABLE `engine4_customer_upload` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `engine4_extension`
--

DROP TABLE IF EXISTS `engine4_extension`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `engine4_extension` (
...
--
-- Dumping data for table `engine4_extension`
--

LOCK TABLES `engine4_extension` WRITE;
/*!40000 ALTER TABLE `engine4_extension` DISABLE KEYS */;
INSERT INTO `engine4_extension` VALUES (25,'module','authentication'),(23,'module','registration'),(26,'module','vpos');
/*!40000 ALTER TABLE `engine4_extension` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `engine4_language` VALUES (1,'English','en','en_US.UTF-8,en_US,en-gb,english','gb.png','english','english',1,1);
...
INSERT INTO `engine4_layout` VALUES (1,'Home'),(4,'Default');
...
INSERT INTO `engine4_layout_route` VALUES (33,1,0,'design/page');
/*!40000 ALTER TABLE `engine4_layout_route` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `engine4_mail_template`
--

DROP TABLE IF EXISTS `engine4_mail_template`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `engine4_mail_template` (
...
--
-- Dumping data for table `engine4_mail_template`
--

LOCK TABLES `engine4_mail_template` WRITE;
/*!40000 ALTER TABLE `engine4_mail_template` DISABLE KEYS */;
INSERT INTO `engine4_mail_template` VALUES (5,'2014-07-08 10:20:49','2014-07-08 10:20:49',0),(6,'2014-07-08 10:22:04','2014-07-08 10:22:04',0),(7,'2014-07-08 10:22:58','2014-07-08 10:22:58',0);
/*!40000 ALTER TABLE `engine4_mail_template` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `engine4_mail_template_description`
--

DROP TABLE IF EXISTS `engine4_mail_template_description`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `engine4_mail_template_description` (
...
--
-- Dumping data for table `engine4_mail_template_description`
--

LOCK TABLES `engine4_mail_template_description` WRITE;
/*!40000 ALTER TABLE `engine4_mail_template_description` DISABLE KEYS */;
INSERT INTO `engine4_mail_template_description` VALUES (0,1,'Test','&lt;p&gt;dsfsdf&lt;/p&gt;\r\n'),(5,1,'Welcome Mail','&lt;p&gt;Dear {$user}&lt;/p&gt;\r\n\r\n&lt;p&gt;Welcome to {$config_name}&lt;/p&gt;\r\n\r\n&lt;p&gt;&amp;nbsp;&lt;/p&gt;\r\n\r\n&lt;p&gt;{$config_name} Team&lt;/p&gt;\r\n'),(6,1,'Account Approval','&lt;p&gt;Dear {$user}&lt;/p&gt;\r\n\r\n&lt;p&gt;Your account on {$config_name} has been approved.&lt;/p&gt;\r\n\r\n&lt;p&gt;&amp;nbsp;&lt;/p&gt;\r\n\r\n&lt;p&gt;{$config_name} Team&lt;/p&gt;\r\n'),(7,1,'Password Recovery','&lt;p&gt;Dear {$user}&lt;/p&gt;\r\n\r\n&lt;p&gt;Please follow the link below to reset your password.&lt;/p&gt;\r\n\r\n&lt;p&gt;{$config_name} Team&lt;/p&gt;\r\n');
/*!40000 ALTER TABLE `engine4_mail_template_description` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `engine4_menu`
--

DROP TABLE IF EXISTS `engine4_menu`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `engine4_menu` (
...
--
-- Dumping data for table `engine4_menu`
--

LOCK TABLES `engine4_menu` WRITE;
/*!40000 ALTER TABLE `engine4_menu` DISABLE KEYS */;
INSERT INTO `engine4_menu` VALUES (26,'page_id=4','',0,'left',1,1,1),(27,'page_id=5','',0,'left',1,1,2),(28,'page_id=6','',0,'left',1,1,3),(30,'page_id=7','',0,'right',0,1,1),(31,'','http://lmerchant.semitepayment.com/',1,'right',0,1,2),(32,'page_id=8','',0,'left',0,1,2),(33,'page_id=9','',0,'left',0,1,1),(34,'page_id=12','',0,'left',1,1,4);
/*!40000 ALTER TABLE `engine4_menu` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `engine4_menu_description`
--

DROP TABLE IF EXISTS `engine4_menu_description`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `engine4_menu_description` (
...
--
-- Dumping data for table `engine4_menu_description`
--

LOCK TABLES `engine4_menu_description` WRITE;
/*!40000 ALTER TABLE `engine4_menu_description` DISABLE KEYS */;
INSERT INTO `engine4_menu_description` VALUES (28,1,'Money Laundering'),(26,1,'Legal'),(27,1,'Privacy Policy'),(30,1,'Register'),(31,1,'Login'),(32,1,'Pricing'),(33,1,'Developer'),(34,1,'Merchant Account');
/*!40000 ALTER TABLE `engine4_menu_description` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `engine4_page`
--

DROP TABLE IF EXISTS `engine4_page`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `engine4_page` (
  `page_id` int(11) NOT NULL AUTO_INCREMENT,
  `image` varchar(255) DEFAULT NULL,
  `show_header` tinyint(1) NOT NULL DEFAULT '0',
  `show_title` tinyint(1) NOT NULL DEFAULT '0',
  `show_sub_title` tinyint(1) DEFAULT '0',
  `show_breadcrumb` tinyint(1) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `engine4_page`
--

LOCK TABLES `engine4_page` WRITE;
/*!40000 ALTER TABLE `engine4_page` DISABLE KEYS */;
INSERT INTO `engine4_page` VALUES (3,'',1,0,0,0,0,0,1,'2014-06-16 16:21:43','2014-08-05 18:15:55'),(4,'',1,1,1,0,0,0,1,'2014-06-24 19:28:10','2014-08-05 18:16:08'),(5,'',1,1,1,0,0,0,1,'2014-06-24 19:34:25','2014-08-05 18:16:23'),(6,'',1,1,1,0,0,0,1,'2014-06-24 19:35:23','2014-08-05 18:16:15'),(7,'',0,0,0,0,0,0,1,'2014-07-18 11:43:02','2014-08-05 18:10:18'),(8,'',1,1,1,0,0,0,1,'2014-08-02 15:24:57','2014-08-05 18:16:39'),(9,'',1,1,0,0,0,0,1,'2014-08-02 15:31:55','2014-08-16 10:58:39'),(10,'',0,0,0,0,0,1,1,'2014-08-06 09:29:46','2014-08-06 09:29:46'),(11,'',0,1,0,0,0,0,1,'2014-08-16 12:14:40','2014-08-16 12:32:43'),(12,'',1,1,0,0,0,0,1,'2014-08-31 11:41:05','2014-08-31 11:58:51');
/*!40000 ALTER TABLE `engine4_page` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `engine4_page_description`
--

DROP TABLE IF EXISTS `engine4_page_description`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `engine4_page_description` (
  `page_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `title` varchar(96) NOT NULL,
  `sub_title` varchar(96) DEFAULT NULL,
...
--
-- Dumping data for table `engine4_page_description`
--

LOCK TABLES `engine4_page_description` WRITE;
/*!40000 ALTER TABLE `engine4_page_description` DISABLE KEYS */;
INSERT INTO `engine4_page_description` VALUES (3,1,'Home','Semite Payment','',''),(4,1,'Legal','Merchant Terms of Use','',''),(5,1,'Privacy Polity','Terms of Use and Privacy Policy','',''),(6,1,'Money Laundering','Money Laundering Prevention','',''),(7,1,'Register','','',''),(8,1,'Unlimited payment processing, free forever.','Simple plans for more access to the industry’s leading client success team.','',''),(9,1,'A simple, RESTful API to the most powerful Semite Payment infrastructure on the planet.','','',''),(10,1,'VPOS','','',''),(11,1,'Registration Success','Your Account Has Been Created!','',''),(12,1,'Merchant Account Application Requirements','','','');
/*!40000 ALTER TABLE `engine4_page_description` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `engine4_page_to_application`
--

DROP TABLE IF EXISTS `engine4_page_to_application`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `engine4_page_to_application` (
  `page_id` int(11) NOT NULL,
  `application_id` int(11) NOT NULL,
  PRIMARY KEY (`page_id`,`application_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `engine4_page_to_application`
--

LOCK TABLES `engine4_page_to_application` WRITE;
/*!40000 ALTER TABLE `engine4_page_to_application` DISABLE KEYS */;
INSERT INTO `engine4_page_to_application` VALUES (3,0),(4,0),(5,0),(6,0),(7,0),(8,0),(9,0),(10,0),(11,0),(12,0);
/*!40000 ALTER TABLE `engine4_page_to_application` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `engine4_page_to_block`
--

DROP TABLE IF EXISTS `engine4_page_to_block`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `engine4_page_to_block` (
  `page_to_block_id` int(11) NOT NULL AUTO_INCREMENT,
  `page_id` int(11) NOT NULL,
  `block_id` int(11) NOT NULL,
  PRIMARY KEY (`page_to_block_id`)
) ENGINE=InnoDB AUTO_INCREMENT=42 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `engine4_page_to_block`
--

LOCK TABLES `engine4_page_to_block` WRITE;
/*!40000 ALTER TABLE `engine4_page_to_block` DISABLE KEYS */;
INSERT INTO `engine4_page_to_block` VALUES (24,7,30),(25,3,31),(26,3,32),(27,3,33),(28,3,34),(29,4,26),(30,6,28),(31,5,27),(33,8,35),(34,10,37),(35,9,36),(37,11,38),(40,12,39),(41,12,34);
/*!40000 ALTER TABLE `engine4_page_to_block` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `engine4_page_to_layout`
--

DROP TABLE IF EXISTS `engine4_page_to_layout`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `engine4_page_to_layout` (
  `page_id` int(11) NOT NULL,
  `application_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL,
  PRIMARY KEY (`page_id`,`application_id`)
...
--
-- Dumping data for table `engine4_page_to_layout`
--

LOCK TABLES `engine4_page_to_layout` WRITE;
/*!40000 ALTER TABLE `engine4_page_to_layout` DISABLE KEYS */;
INSERT INTO `engine4_page_to_layout` VALUES (2,0,1),(3,0,1),(12,0,1);
/*!40000 ALTER TABLE `engine4_page_to_layout` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `engine4_setting` VALUES (1943,1,'config','config_url','http://local.semitepayment.com/api/',0),(1944,1,'config','config_ssl','https://local.semitepayment.com/api/',0),(1945,1,'config','config_name','Semite Payment API',0),(1946,1,'config','config_owner','SEMITE LLC',0),(1947,1,'config','config_address','Kaludjerica Karadjordjeva 45\r\nGrock - Beograd\r\n11130 Serbia',0),(1948,1,'config','config_email','info@semitepayment.com',0),(1949,1,'config','config_telephone','+381 656 72 8972',0),(1950,1,'config','config_fax','',0),(1951,1,'config','config_title','Semite Payment API',0),(1952,1,'config','config_meta_description','',0),(1953,1,'config','config_template','default',0),(1954,1,'config','config_page','3',0),(1955,1,'config','config_country_id','243',0),(1956,1,'config','config_zone_id','3994',0),(1957,1,'config','config_language','en',0),(1958,1,'config','config_currency','EUR',0),(1959,1,'config','config_customer_group_id','1',0),(1960,1,'config','config_account_id','82',0),(1961,1,'config','config_logo','',0),(1962,1,'config','config_icon','',0),(1963,1,'config','config_secure','0',0),(4068,0,'vpos','vpos_module','a:9:{s:12:\"company_name\";s:22:\"Islek Turizm Sti. Ltd.\";s:13:\"company_owner\";s:11:\"Hakan Islek\";s:12:\"company_code\";s:7:\"9709410\";s:8:\"terminal\";s:8:\"00063059\";s:12:\"organization\";s:3:\"009\";s:11:\"merchant_id\";s:18:\"900000000009709410\";s:12:\"merchant_key\";s:8:\"Jhf2DuN4\";s:6:\"secure\";s:1:\"1\";s:6:\"status\";s:1:\"1\";}',1),(4069,0,'config','config_name','Semite Payment',0),(4070,0,'config','config_owner','Semite LLC',0),(4071,0,'config','config_address','My Application Address',0),(4072,0,'config','config_email','ahmet.gudenoglu@gmail.com',0),(4073,0,'config','config_telephone','+1 (234) 456-7890',0),(4074,0,'config','config_fax','',0),(4075,0,'config','config_title','Semite LLC',0),(4076,0,'config','config_meta_description','My Application',0),(4077,0,'config','config_template','semitepayment',0),(4078,0,'config','config_layout_id','1',0),(4079,0,'config','config_page_id','3',0),(4080,0,'config','config_country_id','243',0),(4081,0,'config','config_zone_id','3994',0),(4082,0,'config','config_language','en',0),(4083,0,'config','config_admin_language','en',0),(4084,0,'config','config_currency','TRY',0),(4085,0,'config','config_currency_auto','1',0),(4086,0,'config','config_admin_limit','20',0),(4087,0,'config','config_customer_online','0',0),(4088,0,'config','config_customer_group_id','2',0),(4089,0,'config','config_account_id','85',0),(4090,0,'config','config_mail_template_id','5',0),(4091,0,'config','config_transaction_autocapture','1',0),(4092,0,'config','config_transaction_status_id','1',0),(4093,0,'config','config_complete_transaction_status_id','5',0),(4094,0,'config','config_invoice_prefix','SP-2014-00',0),(4095,0,'config','config_transfer_status_id','1',0),(4096,0,'config','config_complete_transfer_status_id','5',0),(4097,0,'config','config_transfer_comission','5',0),(4098,0,'config','config_affiliate_id','87',0),(4099,0,'config','config_commission','5',0),(4100,0,'config','config_creditcard_status_id','1',0),(4101,0,'config','config_complete_creditcard_status_id','18',0),(4102,0,'config','config_bankaccount_status_id','1',0),(4103,0,'config','config_complete_bankaccount_status_id','18',0),(4104,0,'config','config_test_secretkey_api_prefix','sk_test_',0),(4105,0,'config','config_test_publickey_api_prefix','pk_test_',0),(4106,0,'config','config_live_secretkey_api_prefix','sk_live_',0),(4107,0,'config','config_live_publickey_api_prefix','pk_live_',0),(4108,0,'config','config_logo','data/semite_logo.png',0),(4109,0,'config','config_icon','data/Images/Payment-Methods-Bank-cards-icon-145x145.png',0),(4110,0,'config','config_featured_image_width','145',0),(4111,0,'config','config_featured_image_height','145',0),(4112,0,'config','config_ftp_host','develop.limolabs.com',0),(4113,0,'config','config_ftp_port','21',0),(4114,0,'config','config_ftp_username','',0),(4115,0,'config','config_ftp_password','',0),(4116,0,'config','config_ftp_root','',0),(4117,0,'config','config_ftp_status','0',0),(4118,0,'config','config_mail_protocol','mail',0),(4119,0,'config','config_mail_parameter','',0),(4120,0,'config','config_smtp_host','',0),(4121,0,'config','config_smtp_username','',0),(4122,0,'config','config_smtp_password','',0),(4123,0,'config','config_smtp_port','25',0),(4124,0,'config','config_smtp_timeout','5',0),(4125,0,'config','config_alert_mail','0',0),(4126,0,'config','config_account_mail','0',0),(4127,0,'config','config_alert_emails','',0),(4128,0,'config','config_success','11',0),(4129,0,'config','config_secure','0',0),(4130,0,'config','config_shared','0',0),(4131,0,'config','config_robots','abot\r\ndbot\r\nebot\r\nhbot\r\nkbot\r\nlbot\r\nmbot\r\nnbot\r\nobot\r\npbot\r\nrbot\r\nsbot\r\ntbot\r\nvbot\r\nybot\r\nzbot\r\nbot.\r\nbot/\r\n_bot\r\n.bot\r\n/bot\r\n-bot\r\n:bot\r\n(bot\r\ncrawl\r\nslurp\r\nspider\r\nseek\r\naccoona\r\nacoon\r\nadressendeutschland\r\nah-ha.com\r\nahoy\r\naltavista\r\nananzi\r\nanthill\r\nappie\r\narachnophilia\r\narale\r\naraneo\r\naranha\r\narchitext\r\naretha\r\narks\r\nasterias\r\natlocal\r\natn\r\natomz\r\naugurfind\r\nbackrub\r\nbannana_bot\r\nbaypup\r\nbdfetch\r\nbig brother\r\nbiglotron\r\nbjaaland\r\nblackwidow\r\nblaiz\r\nblog\r\nblo.\r\nbloodhound\r\nboitho\r\nbooch\r\nbradley\r\nbutterfly\r\ncalif\r\ncassandra\r\nccubee\r\ncfetch\r\ncharlotte\r\nchurl\r\ncienciaficcion\r\ncmc\r\ncollective\r\ncomagent\r\ncombine\r\ncomputingsite\r\ncsci\r\ncurl\r\ncusco\r\ndaumoa\r\ndeepindex\r\ndelorie\r\ndepspid\r\ndeweb\r\ndie blinde kuh\r\ndigger\r\nditto\r\ndmoz\r\ndocomo\r\ndownload express\r\ndtaagent\r\ndwcp\r\nebiness\r\nebingbong\r\ne-collector\r\nejupiter\r\nemacs-w3 search engine\r\nesther\r\nevliya celebi\r\nezresult\r\nfalcon\r\nfelix ide\r\nferret\r\nfetchrover\r\nfido\r\nfindlinks\r\nfireball\r\nfish search\r\nfouineur\r\nfunnelweb\r\ngazz\r\ngcreep\r\ngenieknows\r\ngetterroboplus\r\ngeturl\r\nglx\r\ngoforit\r\ngolem\r\ngrabber\r\ngrapnel\r\ngralon\r\ngriffon\r\ngromit\r\ngrub\r\ngulliver\r\nhamahakki\r\nharvest\r\nhavindex\r\nhelix\r\nheritrix\r\nhku www octopus\r\nhomerweb\r\nhtdig\r\nhtml index\r\nhtml_analyzer\r\nhtmlgobble\r\nhubater\r\nhyper-decontextualizer\r\nia_archiver\r\nibm_planetwide\r\nichiro\r\niconsurf\r\niltrovatore\r\nimage.kapsi.net\r\nimagelock\r\nincywincy\r\nindexer\r\ninfobee\r\ninformant\r\ningrid\r\ninktomisearch.com\r\ninspector web\r\nintelliagent\r\ninternet shinchakubin\r\nip3000\r\niron33\r\nisraeli-search\r\nivia\r\njack\r\njakarta\r\njavabee\r\njetbot\r\njumpstation\r\nkatipo\r\nkdd-explorer\r\nkilroy\r\nknowledge\r\nkototoi\r\nkretrieve\r\nlabelgrabber\r\nlachesis\r\nlarbin\r\nlegs\r\nlibwww\r\nlinkalarm\r\nlink validator\r\nlinkscan\r\nlockon\r\nlwp\r\nlycos\r\nmagpie\r\nmantraagent\r\nmapoftheinternet\r\nmarvin/\r\nmattie\r\nmediafox\r\nmediapartners\r\nmercator\r\nmerzscope\r\nmicrosoft url control\r\nminirank\r\nmiva\r\nmj12\r\nmnogosearch\r\nmoget\r\nmonster\r\nmoose\r\nmotor\r\nmultitext\r\nmuncher\r\nmuscatferret\r\nmwd.search\r\nmyweb\r\nnajdi\r\nnameprotect\r\nnationaldirectory\r\nnazilla\r\nncsa beta\r\nnec-meshexplorer\r\nnederland.zoek\r\nnetcarta webmap engine\r\nnetmechanic\r\nnetresearchserver\r\nnetscoop\r\nnewscan-online\r\nnhse\r\nnokia6682/\r\nnomad\r\nnoyona\r\nnutch\r\nnzexplorer\r\nobjectssearch\r\noccam\r\nomni\r\nopen text\r\nopenfind\r\nopenintelligencedata\r\norb search\r\nosis-project\r\npack rat\r\npageboy\r\npagebull\r\npage_verifier\r\npanscient\r\nparasite\r\npartnersite\r\npatric\r\npear.\r\npegasus\r\nperegrinator\r\npgp key agent\r\nphantom\r\nphpdig\r\npicosearch\r\npiltdownman\r\npimptrain\r\npinpoint\r\npioneer\r\npiranha\r\nplumtreewebaccessor\r\npogodak\r\npoirot\r\npompos\r\npoppelsdorf\r\npoppi\r\npopular iconoclast\r\npsycheclone\r\npublisher\r\npython\r\nrambler\r\nraven search\r\nroach\r\nroad runner\r\nroadhouse\r\nrobbie\r\nrobofox\r\nrobozilla\r\nrules\r\nsalty\r\nsbider\r\nscooter\r\nscoutjet\r\nscrubby\r\nsearch.\r\nsearchprocess\r\nsemanticdiscovery\r\nsenrigan\r\nsg-scout\r\nshai\'hulud\r\nshark\r\nshopwiki\r\nsidewinder\r\nsift\r\nsilk\r\nsimmany\r\nsite searcher\r\nsite valet\r\nsitetech-rover\r\nskymob.com\r\nsleek\r\nsmartwit\r\nsna-\r\nsnappy\r\nsnooper\r\nsohu\r\nspeedfind\r\nsphere\r\nsphider\r\nspinner\r\nspyder\r\nsteeler/\r\nsuke\r\nsuntek\r\nsupersnooper\r\nsurfnomore\r\nsven\r\nsygol\r\nszukacz\r\ntach black widow\r\ntarantula\r\ntempleton\r\n/teoma\r\nt-h-u-n-d-e-r-s-t-o-n-e\r\ntheophrastus\r\ntitan\r\ntitin\r\ntkwww\r\ntoutatis\r\nt-rex\r\ntutorgig\r\ntwiceler\r\ntwisted\r\nucsd\r\nudmsearch\r\nurl check\r\nupdated\r\nvagabondo\r\nvalkyrie\r\nverticrawl\r\nvictoria\r\nvision-search\r\nvolcano\r\nvoyager/\r\nvoyager-hc\r\nw3c_validator\r\nw3m2\r\nw3mir\r\nwalker\r\nwallpaper\r\nwanderer\r\nwauuu\r\nwavefire\r\nweb core\r\nweb hopper\r\nweb wombat\r\nwebbandit\r\nwebcatcher\r\nwebcopy\r\nwebfoot\r\nweblayers\r\nweblinker\r\nweblog monitor\r\nwebmirror\r\nwebmonkey\r\nwebquest\r\nwebreaper\r\nwebsitepulse\r\nwebsnarf\r\nwebstolperer\r\nwebvac\r\nwebwalk\r\nwebwatch\r\nwebwombat\r\nwebzinger\r\nwhizbang\r\nwhowhere\r\nwild ferret\r\nworldlight\r\nwwwc\r\nwwwster\r\nxenu\r\nxget\r\nxift\r\nxirq\r\nyandex\r\nyanga\r\nyeti\r\nyodao\r\nzao\r\nzippp\r\nzyborg',0),(4132,0,'config','config_seo_url','1',0),(4133,0,'config','config_file_extension_allowed','txt\r\npng\r\njpe\r\njpeg\r\njpg\r\ngif\r\nbmp\r\nico\r\ntiff\r\ntif\r\nsvg\r\nsvgz\r\nzip\r\nrar\r\nmsi\r\ncab\r\nmp3\r\nqt\r\nmov\r\npdf\r\npsd\r\nai\r\neps\r\nps\r\ndoc\r\nrtf\r\nxls\r\nppt\r\nodt\r\nods',0),(4134,0,'config','config_file_mime_allowed','text/plain\r\nimage/png\r\nimage/jpeg\r\nimage/jpeg\r\nimage/jpeg\r\nimage/gif\r\nimage/bmp\r\nimage/vnd.microsoft.icon\r\nimage/tiff\r\nimage/tiff\r\nimage/svg+xml\r\nimage/svg+xml\r\napplication/zip\r\napplication/x-rar-compressed\r\napplication/x-msdownload\r\napplication/vnd.ms-cab-compressed\r\naudio/mpeg\r\nvideo/quicktime\r\nvideo/quicktime\r\napplication/pdf\r\nimage/vnd.adobe.photoshop\r\napplication/postscript\r\napplication/postscript\r\napplication/postscript\r\napplication/msword\r\napplication/rtf\r\napplication/vnd.ms-excel\r\napplication/vnd.ms-powerpoint\r\napplication/vnd.oasis.opendocument.text\r\napplication/vnd.oasis.opendocument.spreadsheet',0),(4135,0,'config','config_maintenance','0',0),(4136,0,'config','config_password','1',0),(4137,0,'config','config_encryption','f42898ec41938bd417096625223dc4fa',0),(4138,0,'config','config_compression','5',0),(4139,0,'config','config_error_display','1',0),(4140,0,'config','config_error_log','0',0),(4141,0,'config','config_error_filename','error.txt',0),(4142,0,'config','config_google_analytics','&lt;script&gt;\r\n  (function(i,s,o,g,r,a,m){i[\'GoogleAnalyticsObject\']=r;i[r]=i[r]||function(){\r\n  (i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),\r\n  m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)\r\n  })(window,document,\'script\',\'//www.google-analytics.com/analytics.js\',\'ga\');\r\n\r\n  ga(\'create\', \'UA-33355876-3\', \'semitepayment.com\');\r\n  ga(\'send\', \'pageview\');\r\n\r\n&lt;/script&gt;',0),(4143,2,'config','config_url','http://lmerchant.semitepayment.com/',0),(4144,2,'config','config_ssl','https://lmerchant.semitepayment.com/',0),(4145,2,'config','config_name','Semite Payment Account',0),(4146,2,'config','config_owner','SEMITE LLC',0),(4147,2,'config','config_address','Kaludjerica Karadjowdjeva 45\r\nGrocka - Beograd\r\n11130 Serbia',0),(4148,2,'config','config_email','info@semitepayment.com',0),(4149,2,'config','config_telephone','+381 656 72 8972',0),(4150,2,'config','config_fax','',0),(4151,2,'config','config_title','Merchant Account',0),(4152,2,'config','config_meta_description','',0),(4153,2,'config','config_template','default',0),(4154,2,'config','config_page','3',0),(4155,2,'config','config_country_id','243',0),(4156,2,'config','config_zone_id','3994',0),(4157,2,'config','config_language','en',0),(4158,2,'config','config_currency','TRY',0),(4159,2,'config','config_customer_group_id','1',0),(4160,2,'config','config_account_id','82',0),(4161,2,'config','config_logo','',0),(4162,2,'config','config_icon','',0),(4163,2,'config','config_secure','0',0);
/*!40000 ALTER TABLE `engine4_setting` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `engine4_task`
--

DROP TABLE IF EXISTS `engine4_task`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `engine4_task` (
...
--
-- Dumping data for table `engine4_task`
--

LOCK TABLES `engine4_task` WRITE;
/*!40000 ALTER TABLE `engine4_task` DISABLE KEYS */;
/*!40000 ALTER TABLE `engine4_task` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `engine4_transaction_status`
--

DROP TABLE IF EXISTS `engine4_transaction_status`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `engine4_transaction_status` (
...
--
-- Dumping data for table `engine4_transaction_status`
--

LOCK TABLES `engine4_transaction_status` WRITE;
/*!40000 ALTER TABLE `engine4_transaction_status` DISABLE KEYS */;
INSERT INTO `engine4_transaction_status` VALUES (2,1,'Processing'),(3,1,'Shipped'),(7,1,'Canceled'),(5,1,'Complete'),(8,1,'Denied'),(9,1,'Canceled Reversal'),(10,1,'Failed'),(17,1,'Refunded'),(12,1,'Reversed'),(13,1,'Chargeback'),(1,1,'Pending'),(16,1,'Voided'),(15,1,'Processed'),(14,1,'Expired'),(18,1,'Verified');
/*!40000 ALTER TABLE `engine4_transaction_status` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `engine4_url_alias`
--

DROP TABLE IF EXISTS `engine4_url_alias`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `engine4_url_alias` (
  `url_alias_id` int(11) NOT NULL AUTO_INCREMENT,
  `permalink_id` varchar(45) NOT NULL,
  `query` varchar(255) NOT NULL,
  `keyword` varchar(255) NOT NULL,
  PRIMARY KEY (`url_alias_id`,`permalink_id`)
) ENGINE=MyISAM AUTO_INCREMENT=120 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `engine4_url_alias`
--

LOCK TABLES `engine4_url_alias` WRITE;
/*!40000 ALTER TABLE `engine4_url_alias` DISABLE KEYS */;
INSERT INTO `engine4_url_alias` VALUES (104,'','page_id=3','home'),(105,'','page_id=4','legal'),(107,'','page_id=5','privacy-policy'),(106,'','page_id=6','money-laundering '),(103,'','page_id=7','register'),(109,'','page_id=8','pricing'),(111,'','page_id=9','developer'),(110,'','page_id=10','vpos'),(115,'','page_id=11','success'),(119,'','page_id=12','merchant-account-requirement');
/*!40000 ALTER TABLE `engine4_url_alias` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `engine4_user` VALUES (1,1,'admin','51d412de9ba323359faf887bbbf0cd42f4445313','00a84ddde','Ahmet','Gudenoglu','ahmet.gudenoglu@gmail.com','','127.0.0.1','data/Users/ahmet.jpg',1,'2012-11-02 07:46:47');
...
INSERT INTO `engine4_user_group` VALUES (1,'Administrator','a:2:{s:6:\"access\";a:28:{i:0;s:16:\"account/customer\";i:1;s:23:\"account/customer_ban_ip\";i:2;s:22:\"account/customer_group\";i:3;s:16:\"account/transfer\";i:4;s:19:\"application/content\";i:5;s:24:\"application/content_type\";i:6;s:16:\"application/task\";i:7;s:18:\"common/filemanager\";i:8;s:12:\"design/block\";i:9;s:13:\"design/layout\";i:10;s:11:\"design/mail\";i:11;s:11:\"design/menu\";i:12;s:11:\"design/page\";i:13;s:16:\"extension/module\";i:14;s:20:\"localisation/country\";i:15;s:21:\"localisation/currency\";i:16;s:21:\"localisation/language\";i:17;s:31:\"localisation/transaction_status\";i:18;s:17:\"localisation/zone\";i:19;s:21:\"module/authentication\";i:20;s:19:\"module/registration\";i:21;s:19:\"setting/application\";i:22;s:15:\"setting/setting\";i:23;s:11:\"tool/backup\";i:24;s:14:\"tool/error_log\";i:25;s:9:\"user/user\";i:26;s:20:\"user/user_permission\";i:27;s:11:\"module/vpos\";}s:6:\"modify\";a:28:{i:0;s:16:\"account/customer\";i:1;s:23:\"account/customer_ban_ip\";i:2;s:22:\"account/customer_group\";i:3;s:16:\"account/transfer\";i:4;s:19:\"application/content\";i:5;s:24:\"application/content_type\";i:6;s:16:\"application/task\";i:7;s:18:\"common/filemanager\";i:8;s:12:\"design/block\";i:9;s:13:\"design/layout\";i:10;s:11:\"design/mail\";i:11;s:11:\"design/menu\";i:12;s:11:\"design/page\";i:13;s:16:\"extension/module\";i:14;s:20:\"localisation/country\";i:15;s:21:\"localisation/currency\";i:16;s:21:\"localisation/language\";i:17;s:31:\"localisation/transaction_status\";i:18;s:17:\"localisation/zone\";i:19;s:21:\"module/authentication\";i:20;s:19:\"module/registration\";i:21;s:19:\"setting/application\";i:22;s:15:\"setting/setting\";i:23;s:11:\"tool/backup\";i:24;s:14:\"tool/error_log\";i:25;s:9:\"user/user\";i:26;s:20:\"user/user_permission\";i:27;s:11:\"module/vpos\";}}'),(2,'Demostration','');
/*!40000 ALTER TABLE `engine4_user_group` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `engine4_withdraw`
--

DROP TABLE IF EXISTS `engine4_withdraw`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `engine4_withdraw` (
  ...
  `date_added` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `date_proceed` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
--
-- Dumping data for table `engine4_withdraw`
--

LOCK TABLES `engine4_withdraw` WRITE;
/*!40000 ALTER TABLE `engine4_withdraw` DISABLE KEYS */;
/*!40000 ALTER TABLE `engine4_withdraw` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `engine4_withdraw_history`
--

DROP TABLE IF EXISTS `engine4_withdraw_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `engine4_withdraw_history` (
  `withdraw_history_id` int(11) NOT NULL AUTO_INCREMENT,
  `withdraw_id` int(11) NOT NULL,
  `withdraw_status_id` int(5) NOT NULL,
  `notify` tinyint(1) NOT NULL DEFAULT '0',
  `comment` text NOT NULL,
  `date_added` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`withdraw_history_id`)
) ENGINE=MyISAM AUTO_INCREMENT=73 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `engine4_withdraw_history`
--

LOCK TABLES `engine4_withdraw_history` WRITE;
/*!40000 ALTER TABLE `engine4_withdraw_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `engine4_withdraw_history` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-10-19 11:17:31
